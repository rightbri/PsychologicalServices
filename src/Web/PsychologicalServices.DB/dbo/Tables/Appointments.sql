CREATE TABLE [dbo].[Appointments] (
    ...
    [CreateDate]          DATETIME CONSTRAINT [DF_Appointments_CreateDate] DEFAULT (getdate()) NOT NULL,
    [CreateUserId]        INT      NOT NULL,
    [UpdateDate]          DATETIME CONSTRAINT [DF_Appointments_UpdateDate] DEFAULT (getdate()) NOT NULL,
