CREATE TABLE [dbo].[Notes] (
    ...
    [UpdateDate]   DATETIMEOFFSET (7) CONSTRAINT [DF_Notes_UpdateDate] DEFAULT (getdate()) NOT NULL,
    [CreateUserId] INT                NOT NULL,
    [CreateDate]   DATETIMEOFFSET (7) CONSTRAINT [DF_Notes_CreateDate] DEFAULT (getdate()) NOT NULL,
