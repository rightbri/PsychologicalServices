...
{
	/// <summary>Implements the relations factory for the entity: IssueInDisputeInvoiceAmount. </summary>
	...
	internal static class StaticIssueInDisputeInvoiceAmountRelations
	{
		internal static readonly IEntityRelation CompanyEntityUsingCompanyIdStatic = new IssueInDisputeInvoiceAmountRelations().CompanyEntityUsingCompanyId;
		internal static readonly IEntityRelation IssueInDisputeEntityUsingIssueInDisputeIdStatic = new IssueInDisputeInvoiceAmountRelations().IssueInDisputeEntityUsingIssueInDisputeId;

		/// <summary>CTor</summary>
		static StaticIssueInDisputeInvoiceAmountRelations()
		{
		}
	}
}
