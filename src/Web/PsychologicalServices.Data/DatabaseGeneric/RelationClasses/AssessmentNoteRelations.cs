...
{
	/// <summary>Implements the static Relations variant for the entity: AssessmentNote. </summary>
	public partial class AssessmentNoteRelations
	{
		/// <summary>CTor</summary>
		public AssessmentNoteRelations()
		{
		}

		/// <summary>Gets all relations of the AssessmentNoteEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between AssessmentNoteEntity and AssessmentEntity over the m:1 relation they have, using the relation between the fields:
		/// AssessmentNote.AssessmentId - Assessment.AssessmentId
		/// </summary>
		public virtual IEntityRelation AssessmentEntityUsingAssessmentId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("AssessmentNoteEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between AssessmentNoteEntity and NoteEntity over the m:1 relation they have, using the relation between the fields:
