...
{
	/// <summary>Implements the relations factory for the entity: AppointmentStatusInvoiceRate. </summary>
	...
	internal static class StaticAppointmentStatusInvoiceRateRelations
	{
		internal static readonly IEntityRelation AppointmentSequenceEntityUsingAppointmentSequenceIdStatic = new AppointmentStatusInvoiceRateRelations().AppointmentSequenceEntityUsingAppointmentSequenceId;
		internal static readonly IEntityRelation AppointmentStatusEntityUsingAppointmentStatusIdStatic = new AppointmentStatusInvoiceRateRelations().AppointmentStatusEntityUsingAppointmentStatusId;
		internal static readonly IEntityRelation CompanyEntityUsingCompanyIdStatic = new AppointmentStatusInvoiceRateRelations().CompanyEntityUsingCompanyId;
		internal static readonly IEntityRelation ReferralSourceEntityUsingReferralSourceIdStatic = new AppointmentStatusInvoiceRateRelations().ReferralSourceEntityUsingReferralSourceId;

		/// <summary>CTor</summary>
		static StaticAppointmentStatusInvoiceRateRelations()
		{
		}
	}
}
