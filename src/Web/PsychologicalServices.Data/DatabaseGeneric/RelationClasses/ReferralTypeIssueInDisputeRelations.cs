...
{
	/// <summary>Implements the relations factory for the entity: ReferralTypeIssueInDispute. </summary>
	...
	internal static class StaticReferralTypeIssueInDisputeRelations
	{
		internal static readonly IEntityRelation IssueInDisputeEntityUsingIssueInDisputeIdStatic = new ReferralTypeIssueInDisputeRelations().IssueInDisputeEntityUsingIssueInDisputeId;
		internal static readonly IEntityRelation ReferralTypeEntityUsingReferralTypeIdStatic = new ReferralTypeIssueInDisputeRelations().ReferralTypeEntityUsingReferralTypeId;

		/// <summary>CTor</summary>
		static StaticReferralTypeIssueInDisputeRelations()
		{
		}
	}
}
