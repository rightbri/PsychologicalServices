...
{
	/// <summary>Implements the relations factory for the entity: Right. </summary>
	...
	internal static class StaticRightRelations
	{
		internal static readonly IEntityRelation RoleRightEntityUsingRightIdStatic = new RightRelations().RoleRightEntityUsingRightId;

		/// <summary>CTor</summary>
		static StaticRightRelations()
		{
		}
	}
}
