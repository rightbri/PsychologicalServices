...
namespace PsychologicalServices.Data.RelationClasses
{
	...
	public partial class InvoiceAppointmentRelations
	{
		...
		public virtual List<IEntityRelation> GetAllRelations()
		{
			...
			toReturn.Add(this.InvoiceLineEntityUsingInvoiceAppointmentId);
		...
		/// <summary>Returns a new IEntityRelation object, between InvoiceAppointmentEntity and InvoiceLineEntity over the 1:n relation they have, using the relation between the fields:
		/// InvoiceAppointment.InvoiceAppointmentId - InvoiceLine.InvoiceAppointmentId
		/// </summary>
		public virtual IEntityRelation InvoiceLineEntityUsingInvoiceAppointmentId
		{
			get
			{
				...
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("InvoiceAppointmentEntity", true);
