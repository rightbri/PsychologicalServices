...
{
	/// <summary>Implements the relations factory for the entity: InvoiceAppointment. </summary>
	...
	internal static class StaticInvoiceAppointmentRelations
	{
		internal static readonly IEntityRelation AppointmentEntityUsingAppointmentIdStatic = new InvoiceAppointmentRelations().AppointmentEntityUsingAppointmentId;
		internal static readonly IEntityRelation InvoiceEntityUsingInvoiceIdStatic = new InvoiceAppointmentRelations().InvoiceEntityUsingInvoiceId;

		/// <summary>CTor</summary>
		static StaticInvoiceAppointmentRelations()
		{
		}
	}
}
