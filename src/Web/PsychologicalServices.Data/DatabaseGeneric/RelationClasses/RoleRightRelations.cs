...
{
	/// <summary>Implements the relations factory for the entity: RoleRight. </summary>
	...
	internal static class StaticRoleRightRelations
	{
		internal static readonly IEntityRelation RightEntityUsingRightIdStatic = new RoleRightRelations().RightEntityUsingRightId;
		internal static readonly IEntityRelation RoleEntityUsingRoleIdStatic = new RoleRightRelations().RoleEntityUsingRoleId;

		/// <summary>CTor</summary>
		static StaticRoleRightRelations()
		{
		}
	}
}
