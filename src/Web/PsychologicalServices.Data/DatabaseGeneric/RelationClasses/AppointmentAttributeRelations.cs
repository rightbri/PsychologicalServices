...
{
	/// <summary>Implements the relations factory for the entity: AppointmentAttribute. </summary>
	...
	internal static class StaticAppointmentAttributeRelations
	{
		internal static readonly IEntityRelation AppointmentEntityUsingAppointmentIdStatic = new AppointmentAttributeRelations().AppointmentEntityUsingAppointmentId;
		internal static readonly IEntityRelation AttributeEntityUsingAttributeIdStatic = new AppointmentAttributeRelations().AttributeEntityUsingAttributeId;

		/// <summary>CTor</summary>
		static StaticAppointmentAttributeRelations()
		{
		}
	}
}
