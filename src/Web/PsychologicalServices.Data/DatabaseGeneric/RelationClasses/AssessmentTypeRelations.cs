...
{
	/// <summary>Implements the relations factory for the entity: AssessmentType. </summary>
	...
	internal static class StaticAssessmentTypeRelations
	{
		internal static readonly IEntityRelation AssessmentEntityUsingAssessmentTypeIdStatic = new AssessmentTypeRelations().AssessmentEntityUsingAssessmentTypeId;
		internal static readonly IEntityRelation AssessmentTypeAttributeTypeEntityUsingAssessmentTypeIdStatic = new AssessmentTypeRelations().AssessmentTypeAttributeTypeEntityUsingAssessmentTypeId;
		internal static readonly IEntityRelation AssessmentTypeInvoiceAmountEntityUsingAssessmentTypeIdStatic = new AssessmentTypeRelations().AssessmentTypeInvoiceAmountEntityUsingAssessmentTypeId;
		internal static readonly IEntityRelation AssessmentTypeReportTypeEntityUsingAssessmentTypeIdStatic = new AssessmentTypeRelations().AssessmentTypeReportTypeEntityUsingAssessmentTypeId;
		internal static readonly IEntityRelation CompanyEntityUsingNewAssessmentAssessmentTypeIdStatic = new AssessmentTypeRelations().CompanyEntityUsingNewAssessmentAssessmentTypeId;
		internal static readonly IEntityRelation PsychometristInvoiceAmountEntityUsingAssessmentTypeIdStatic = new AssessmentTypeRelations().PsychometristInvoiceAmountEntityUsingAssessmentTypeId;

		/// <summary>CTor</summary>
		static StaticAssessmentTypeRelations()
		{
		}
	}
}
