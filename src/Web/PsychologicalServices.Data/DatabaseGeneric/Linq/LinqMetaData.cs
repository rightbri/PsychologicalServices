...
namespace PsychologicalServices.Data.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		public IDataSource GetQueryableForEntity(int typeOfEntity)
		{
			...
			switch((PsychologicalServices.Data.EntityType)typeOfEntity)
			{
				...
				case PsychologicalServices.Data.EntityType.ArbitrationStatusEntity:
					toReturn = this.ArbitrationStatus;
					break;
				...
				case PsychologicalServices.Data.EntityType.AssessmentTestingResultEntity:
					toReturn = this.AssessmentTestingResult;
					break;
		...
		/// <summary>returns the datasource to use in a Linq query when targeting ArbitrationStatusEntity instances in the database.</summary>
		public DataSource2<ArbitrationStatusEntity> ArbitrationStatus
		{
			get { return new DataSource2<ArbitrationStatusEntity>(_adapterToUse, new ElementCreator(), _customFunctionMappings, _contextToUse); }
		}
		...
		/// <summary>returns the datasource to use in a Linq query when targeting AssessmentTestingResultEntity instances in the database.</summary>
		public DataSource2<AssessmentTestingResultEntity> AssessmentTestingResult
		{
			get { return new DataSource2<AssessmentTestingResultEntity>(_adapterToUse, new ElementCreator(), _customFunctionMappings, _contextToUse); }
		}
