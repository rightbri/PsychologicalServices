...
namespace PsychologicalServices.Data.HelperClasses
{
	...
	public partial class AppointmentFields
	{
		...
		/// <summary>Creates a new AppointmentEntity.RoomRentalBillableAmount field instance</summary>
		public static EntityField2 RoomRentalBillableAmount
		{
	...
	public partial class AppointmentStatusFields
	{
		...
		/// <summary>Creates a new AppointmentStatusEntity.ClaimantSeen field instance</summary>
		public static EntityField2 ClaimantSeen
		{
			get { return (EntityField2)EntityFieldFactory.Create(AppointmentStatusFieldIndex.ClaimantSeen);}
		}
		/// <summary>Creates a new AppointmentStatusEntity.IsFinalStatus field instance</summary>
		public static EntityField2 IsFinalStatus
		{
			get { return (EntityField2)EntityFieldFactory.Create(AppointmentStatusFieldIndex.IsFinalStatus);}
		}
	}
