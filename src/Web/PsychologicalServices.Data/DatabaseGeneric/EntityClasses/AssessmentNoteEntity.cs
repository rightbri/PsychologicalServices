...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'AssessmentNote'.<br/><br/></summary>
	[Serializable]
	public partial class AssessmentNoteEntity : CommonEntityBase
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _assessment, new PropertyChangedEventHandler(OnAssessmentPropertyChanged), "Assessment", "AssessmentNotes", PsychologicalServices.Data.RelationClasses.StaticAssessmentNoteRelations.AssessmentEntityUsingAssessmentIdStatic, true, new int[] { (int)AssessmentNoteFieldIndex.AssessmentId });
		}
		...
		{
			SetupSync(relatedEntity, ref _assessment, new PropertyChangedEventHandler( OnAssessmentPropertyChanged ), "Assessment", "AssessmentNotes", PsychologicalServices.Data.RelationClasses.StaticAssessmentNoteRelations.AssessmentEntityUsingAssessmentIdStatic, true, new string[] {  }, new int[] { (int)AssessmentNoteFieldIndex.AssessmentId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _note, new PropertyChangedEventHandler(OnNotePropertyChanged), "Note", "AssessmentNotes", PsychologicalServices.Data.RelationClasses.StaticAssessmentNoteRelations.NoteEntityUsingNoteIdStatic, true, new int[] { (int)AssessmentNoteFieldIndex.NoteId });
		}
		...
		{
			SetupSync(relatedEntity, ref _note, new PropertyChangedEventHandler( OnNotePropertyChanged ), "Note", "AssessmentNotes", PsychologicalServices.Data.RelationClasses.StaticAssessmentNoteRelations.NoteEntityUsingNoteIdStatic, true, new string[] {  }, new int[] { (int)AssessmentNoteFieldIndex.NoteId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AssessmentEntityFactory))),	(IEntityRelation)GetRelationsForField("Assessment")[0], (int)PsychologicalServices.Data.EntityType.AssessmentNoteEntity, (int)PsychologicalServices.Data.EntityType.AssessmentEntity, 0, null, null, null, null, "Assessment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(NoteEntityFactory))),	(IEntityRelation)GetRelationsForField("Note")[0], (int)PsychologicalServices.Data.EntityType.AssessmentNoteEntity, (int)PsychologicalServices.Data.EntityType.NoteEntity, 0, null, null, null, null, "Note", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The AssessmentId property of the Entity AssessmentNote<br/><br/></summary>
		...
		/// <summary> The NoteId property of the Entity AssessmentNote<br/><br/></summary>
		...
		/// <summary> The ShowOnCalendar property of the Entity AssessmentNote<br/><br/></summary>
		...
		public virtual AssessmentEntity Assessment
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "AssessmentNotes", "Assessment", _assessment, true); 
				}
			}
		}
		...
		public virtual NoteEntity Note
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "AssessmentNotes", "Note", _note, true); 
				}
			}
		}
