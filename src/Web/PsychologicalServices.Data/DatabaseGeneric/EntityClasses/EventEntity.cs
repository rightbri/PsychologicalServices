...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'Event'.<br/><br/></summary>
	[Serializable]
	public partial class EventEntity : CommonEntityBase
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _company, new PropertyChangedEventHandler(OnCompanyPropertyChanged), "Company", "Event", PsychologicalServices.Data.RelationClasses.StaticEventRelations.CompanyEntityUsingCompanyIdStatic, true, new int[] { (int)EventFieldIndex.CompanyId });
		}
		...
		{
			SetupSync(relatedEntity, ref _company, new PropertyChangedEventHandler( OnCompanyPropertyChanged ), "Company", "Event", PsychologicalServices.Data.RelationClasses.StaticEventRelations.CompanyEntityUsingCompanyIdStatic, true, new string[] {  }, new int[] { (int)EventFieldIndex.CompanyId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CompanyEntityFactory))),	(IEntityRelation)GetRelationsForField("Company")[0], (int)PsychologicalServices.Data.EntityType.EventEntity, (int)PsychologicalServices.Data.EntityType.CompanyEntity, 0, null, null, null, null, "Company", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The EventId property of the Entity Event<br/><br/></summary>
		...
		/// <summary> The Description property of the Entity Event<br/><br/></summary>
		...
		/// <summary> The Location property of the Entity Event<br/><br/></summary>
		...
		/// <summary> The Time property of the Entity Event<br/><br/></summary>
		...
		/// <summary> The Url property of the Entity Event<br/><br/></summary>
		...
		/// <summary> The Expires property of the Entity Event<br/><br/></summary>
		...
		/// <summary> The IsActive property of the Entity Event<br/><br/></summary>
		...
		/// <summary> The CompanyId property of the Entity Event<br/><br/></summary>
		...
		public virtual CompanyEntity Company
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "Event", "Company", _company, true); 
				}
			}
		}
