...
namespace PsychologicalServices.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			get { return (System.DateTimeOffset)GetValue((int)NoteFieldIndex.UpdateDate, true); }
		...
		{
			get { return (System.DateTimeOffset)GetValue((int)NoteFieldIndex.CreateDate, true); }
