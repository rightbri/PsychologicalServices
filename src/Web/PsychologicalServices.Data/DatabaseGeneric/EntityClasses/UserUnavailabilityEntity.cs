...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'UserUnavailability'.<br/><br/></summary>
	[Serializable]
	public partial class UserUnavailabilityEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _user, new PropertyChangedEventHandler(OnUserPropertyChanged), "User", "UserUnavailabilities", PsychologicalServices.Data.RelationClasses.StaticUserUnavailabilityRelations.UserEntityUsingUserIdStatic, true, new int[] { (int)UserUnavailabilityFieldIndex.UserId });
		}
		...
		{
			SetupSync(relatedEntity, ref _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", "UserUnavailabilities", PsychologicalServices.Data.RelationClasses.StaticUserUnavailabilityRelations.UserEntityUsingUserIdStatic, true, new string[] {  }, new int[] { (int)UserUnavailabilityFieldIndex.UserId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("User")[0], (int)PsychologicalServices.Data.EntityType.UserUnavailabilityEntity, (int)PsychologicalServices.Data.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The Id property of the Entity UserUnavailability<br/><br/></summary>
		...
		/// <summary> The UserId property of the Entity UserUnavailability<br/><br/></summary>
		...
		/// <summary> The StartDate property of the Entity UserUnavailability<br/><br/></summary>
		...
		/// <summary> The EndDate property of the Entity UserUnavailability<br/><br/></summary>
		...
		public virtual UserEntity User
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "UserUnavailabilities", "User", _user, true); 
				}
			}
		}
