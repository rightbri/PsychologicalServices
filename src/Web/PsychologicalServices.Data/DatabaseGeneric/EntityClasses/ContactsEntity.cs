...
namespace PsychologicalServices.Data.EntityClasses
{
			...
			
	{
		...
		private ContactTypesEntity _contactTypes;
		...
		public static partial class MemberNames
		{
			...
			/// <summary>Member name ContactTypes</summary>
			public static readonly string ContactTypes = "ContactTypes";
		...
		public ContactsEntity(System.Int32 contactId):base("ContactsEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this ContactsEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ContactsEntity(System.Int32 contactId, IValidator validator):base("ContactsEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.ContactId = contactId;
		}
		...
		protected ContactsEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_contactTypes = (ContactTypesEntity)info.GetValue("_contactTypes", typeof(ContactTypesEntity));
				if(_contactTypes!=null)
				{
					_contactTypes.AfterSave+=new EventHandler(OnEntityAfterSave);
				}
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			switch((ContactsFieldIndex)fieldIndex)
			{
				case ContactsFieldIndex.ContactTypeId:
					DesetupSyncContactTypes(true, false);
					break;
				case ContactsFieldIndex.AddressId:
					DesetupSyncAddress(true, false);
					break;
				case ContactsFieldIndex.EmployerId:
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntity2 entity)
		{
			switch(propertyName)
			{
				case "Address":
					...
					break;
				case "ContactTypes":
					this.ContactTypes = (ContactTypesEntity)entity;
					break;
				case "Employer":
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Address":
					toReturn.Add(ContactsEntity.Relations.AddressEntityUsingAddressId);
					break;
				case "ContactTypes":
					toReturn.Add(ContactsEntity.Relations.ContactTypesEntityUsingContactTypeId);
					break;
				case "Employer":
					toReturn.Add(ContactsEntity.Relations.EmployerEntityUsingEmployerId);
					break;
		...
		public override void SetRelatedEntity(IEntity2 relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				case "Address":
					...
					break;
				case "ContactTypes":
					SetupSyncContactTypes(relatedEntity);
					break;
				case "Employer":
		...
		public override void UnsetRelatedEntity(IEntity2 relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				case "Address":
					...
					break;
				case "ContactTypes":
					DesetupSyncContactTypes(false, true);
					break;
				case "Employer":
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_contactTypes", (!this.MarkedForDeletion?_contactTypes:null));
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch
		/// the related entity of type 'ContactTypes' to this entity. Use DataAccessAdapter.FetchNewEntity() to fetch this related entity.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoContactTypes()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ContactTypesFields.ContactTypeId, null, ComparisonOperator.Equal, this.ContactTypeId));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(PsychologicalServices.Data.EntityType.ContactsEntity);
		}
		...
		public override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("ContactTypes", _contactTypes);
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_contactTypes!=null)
			{
				_contactTypes.ActiveContext = base.ActiveContext;
			}
			if(_employer!=null)
			{
		...
		{
			base.PerformDesetupSyncRelatedEntity( _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", ContactsEntity.Relations.AddressEntityUsingAddressId, true, signalRelatedEntity, "Contacts", resetFKFields, new int[] { (int)ContactsFieldIndex.AddressId } );		
			_address = null;
		}
		...
		private void SetupSyncAddress(IEntity2 relatedEntity)
		{
			if(_address!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", ContactsEntity.Relations.AddressEntityUsingAddressId, true, new string[] {  } );
			}
		}
		...
		/// <summary> Removes the sync logic for member _contactTypes</summary>
		/// <param name="signalRelatedEntity">If set to true, it will call the related entity's UnsetRelatedEntity method</param>
		/// <param name="resetFKFields">if set to true it will also reset the FK fields pointing to the related entity</param>
		private void DesetupSyncContactTypes(bool signalRelatedEntity, bool resetFKFields)
		{
			base.PerformDesetupSyncRelatedEntity( _contactTypes, new PropertyChangedEventHandler( OnContactTypesPropertyChanged ), "ContactTypes", ContactsEntity.Relations.ContactTypesEntityUsingContactTypeId, true, signalRelatedEntity, "Contacts", resetFKFields, new int[] { (int)ContactsFieldIndex.ContactTypeId } );		
			_contactTypes = null;
		}

		/// <summary> setups the sync logic for member _contactTypes</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncContactTypes(IEntity2 relatedEntity)
		{
			if(_contactTypes!=relatedEntity)
			{
				DesetupSyncContactTypes(true, true);
				_contactTypes = (ContactTypesEntity)relatedEntity;
				base.PerformSetupSyncRelatedEntity( _contactTypes, new PropertyChangedEventHandler( OnContactTypesPropertyChanged ), "ContactTypes", ContactsEntity.Relations.ContactTypesEntityUsingContactTypeId, true, new string[] {  } );
			}
		}
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void OnContactTypesPropertyChanged( object sender, PropertyChangedEventArgs e )
		{
			switch( e.PropertyName )
			{
				default:
		...
		{
			base.PerformDesetupSyncRelatedEntity( _employer, new PropertyChangedEventHandler( OnEmployerPropertyChanged ), "Employer", ContactsEntity.Relations.EmployerEntityUsingEmployerId, true, signalRelatedEntity, "Contacts", resetFKFields, new int[] { (int)ContactsFieldIndex.EmployerId } );		
			_employer = null;
		}
		...
		private void SetupSyncEmployer(IEntity2 relatedEntity)
		{
			if(_employer!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _employer, new PropertyChangedEventHandler( OnEmployerPropertyChanged ), "Employer", ContactsEntity.Relations.EmployerEntityUsingEmployerId, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathAddress
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AddressEntityFactory))),
					(IEntityRelation)GetRelationsForField("Address")[0], (int)PsychologicalServices.Data.EntityType.ContactsEntity, (int)PsychologicalServices.Data.EntityType.AddressEntity, 0, null, null, null, null, "Address", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}

		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'ContactTypes' 
		/// for this entity. Add the object returned by this property to an existing PrefetchPath2 instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathContactTypes
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ContactTypesEntityFactory))),
					(IEntityRelation)GetRelationsForField("ContactTypes")[0], (int)PsychologicalServices.Data.EntityType.ContactsEntity, (int)PsychologicalServices.Data.EntityType.ContactTypesEntity, 0, null, null, null, null, "ContactTypes", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEmployer
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployerEntityFactory))),
					(IEntityRelation)GetRelationsForField("Employer")[0], (int)PsychologicalServices.Data.EntityType.ContactsEntity, (int)PsychologicalServices.Data.EntityType.EmployerEntity, 0, null, null, null, null, "Employer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return (System.Int32)GetValue((int)ContactsFieldIndex.ContactId, true); }
		...
		{
			get { return (System.Int32)GetValue((int)ContactsFieldIndex.ContactTypeId, true); }
			set	{ SetValue((int)ContactsFieldIndex.ContactTypeId, value); }
		}

		/// <summary> The AddressId property of the Entity Contacts<br/><br/>
		/// </summary>
		...
		{
			get { return (Nullable<System.Int32>)GetValue((int)ContactsFieldIndex.AddressId, false); }
			set	{ SetValue((int)ContactsFieldIndex.AddressId, value); }
		}

		/// <summary> The EmployerId property of the Entity Contacts<br/><br/>
		/// </summary>
		...
		{
			get { return (Nullable<System.Int32>)GetValue((int)ContactsFieldIndex.EmployerId, false); }
			set	{ SetValue((int)ContactsFieldIndex.EmployerId, value); }
		}
		...
		/// <summary> Gets / sets related entity of type 'ContactTypesEntity' which has to be set using a fetch action earlier. If no related entity
		/// is set for this property, null is returned. This property is not visible in databound grids.</summary>
		[Browsable(false)]
		public virtual ContactTypesEntity ContactTypes
		{
			get
			{
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_contactTypes != null)
						{
							_contactTypes.UnsetRelatedEntity(this, "Contacts");
						}
					}
					else
					{
		...
		{ 
			get { return (int)PsychologicalServices.Data.EntityType.ContactsEntity; }
		}
		#endregion
