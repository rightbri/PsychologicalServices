...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'AssessmentTypeInvoiceAmounts'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class AssessmentTypeInvoiceAmountsEntity : CommonEntityBase, ISerializable
			...
			
	{
		...
		static AssessmentTypeInvoiceAmountsEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public AssessmentTypeInvoiceAmountsEntity():base("AssessmentTypeInvoiceAmountsEntity")
		{
		...
		public AssessmentTypeInvoiceAmountsEntity(IEntityFields2 fields):base("AssessmentTypeInvoiceAmountsEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this AssessmentTypeInvoiceAmountsEntity</param>
		public AssessmentTypeInvoiceAmountsEntity(IValidator validator):base("AssessmentTypeInvoiceAmountsEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="referralSourceId">PK value for AssessmentTypeInvoiceAmounts which data should be fetched into this AssessmentTypeInvoiceAmounts object</param>
		/// <param name="assessmentTypeId">PK value for AssessmentTypeInvoiceAmounts which data should be fetched into this AssessmentTypeInvoiceAmounts object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AssessmentTypeInvoiceAmountsEntity(System.Int32 referralSourceId, System.Int32 assessmentTypeId):base("AssessmentTypeInvoiceAmountsEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this AssessmentTypeInvoiceAmountsEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AssessmentTypeInvoiceAmountsEntity(System.Int32 referralSourceId, System.Int32 assessmentTypeId, IValidator validator):base("AssessmentTypeInvoiceAmountsEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.ReferralSourceId = referralSourceId;
			this.AssessmentTypeId = assessmentTypeId;
		...
		protected AssessmentTypeInvoiceAmountsEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((AssessmentTypeInvoiceAmountsFieldIndex)fieldIndex)
			{
				case AssessmentTypeInvoiceAmountsFieldIndex.ReferralSourceId:
					DesetupSyncReferralSource(true, false);
					break;
				case AssessmentTypeInvoiceAmountsFieldIndex.AssessmentTypeId:
		...
		{
			return AssessmentTypeInvoiceAmountsEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "AssessmentType":
					toReturn.Add(AssessmentTypeInvoiceAmountsEntity.Relations.AssessmentTypeEntityUsingAssessmentTypeId);
					break;
				case "ReferralSource":
					toReturn.Add(AssessmentTypeInvoiceAmountsEntity.Relations.ReferralSourceEntityUsingReferralSourceId);
					break;
		...
		public bool TestOriginalFieldValueForNull(AssessmentTypeInvoiceAmountsFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(AssessmentTypeInvoiceAmountsFieldIndex fieldIndex)
		{
		...
		{
			return new AssessmentTypeInvoiceAmountsRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(PsychologicalServices.Data.EntityType.AssessmentTypeInvoiceAmountsEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(AssessmentTypeInvoiceAmountsEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _assessmentType, new PropertyChangedEventHandler( OnAssessmentTypePropertyChanged ), "AssessmentType", AssessmentTypeInvoiceAmountsEntity.Relations.AssessmentTypeEntityUsingAssessmentTypeId, true, signalRelatedEntity, "AssessmentTypeInvoiceAmounts", resetFKFields, new int[] { (int)AssessmentTypeInvoiceAmountsFieldIndex.AssessmentTypeId } );		
			_assessmentType = null;
		}
		...
		private void SetupSyncAssessmentType(IEntity2 relatedEntity)
		{
			if(_assessmentType!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _assessmentType, new PropertyChangedEventHandler( OnAssessmentTypePropertyChanged ), "AssessmentType", AssessmentTypeInvoiceAmountsEntity.Relations.AssessmentTypeEntityUsingAssessmentTypeId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _referralSource, new PropertyChangedEventHandler( OnReferralSourcePropertyChanged ), "ReferralSource", AssessmentTypeInvoiceAmountsEntity.Relations.ReferralSourceEntityUsingReferralSourceId, true, signalRelatedEntity, "AssessmentTypeInvoiceAmounts", resetFKFields, new int[] { (int)AssessmentTypeInvoiceAmountsFieldIndex.ReferralSourceId } );		
			_referralSource = null;
		}
		...
		private void SetupSyncReferralSource(IEntity2 relatedEntity)
		{
			if(_referralSource!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _referralSource, new PropertyChangedEventHandler( OnReferralSourcePropertyChanged ), "ReferralSource", AssessmentTypeInvoiceAmountsEntity.Relations.ReferralSourceEntityUsingReferralSourceId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this AssessmentTypeInvoiceAmountsEntity</param>
		...
		public  static AssessmentTypeInvoiceAmountsRelations Relations
		{
			get	{ return new AssessmentTypeInvoiceAmountsRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathAssessmentType
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AssessmentTypeEntityFactory))),
					(IEntityRelation)GetRelationsForField("AssessmentType")[0], (int)PsychologicalServices.Data.EntityType.AssessmentTypeInvoiceAmountsEntity, (int)PsychologicalServices.Data.EntityType.AssessmentTypeEntity, 0, null, null, null, null, "AssessmentType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathReferralSource
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ReferralSourceEntityFactory))),
					(IEntityRelation)GetRelationsForField("ReferralSource")[0], (int)PsychologicalServices.Data.EntityType.AssessmentTypeInvoiceAmountsEntity, (int)PsychologicalServices.Data.EntityType.ReferralSourceEntity, 0, null, null, null, null, "ReferralSource", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return AssessmentTypeInvoiceAmountsEntity.CustomProperties;}
		}
		...
		{
			get { return AssessmentTypeInvoiceAmountsEntity.FieldsCustomProperties;}
		}

		/// <summary> The ReferralSourceId property of the Entity AssessmentTypeInvoiceAmounts<br/><br/>
		/// </summary>
		...
		{
			get { return (System.Int32)GetValue((int)AssessmentTypeInvoiceAmountsFieldIndex.ReferralSourceId, true); }
			set	{ SetValue((int)AssessmentTypeInvoiceAmountsFieldIndex.ReferralSourceId, value); }
		}

		/// <summary> The AssessmentTypeId property of the Entity AssessmentTypeInvoiceAmounts<br/><br/>
		/// </summary>
		...
		{
			get { return (System.Int32)GetValue((int)AssessmentTypeInvoiceAmountsFieldIndex.AssessmentTypeId, true); }
			set	{ SetValue((int)AssessmentTypeInvoiceAmountsFieldIndex.AssessmentTypeId, value); }
		}

		/// <summary> The InvoiceAmount property of the Entity AssessmentTypeInvoiceAmounts<br/><br/>
		/// </summary>
		...
		{
			get { return (System.Int32)GetValue((int)AssessmentTypeInvoiceAmountsFieldIndex.InvoiceAmount, true); }
			set	{ SetValue((int)AssessmentTypeInvoiceAmountsFieldIndex.InvoiceAmount, value); }
		}
		...
		{ 
			get { return (int)PsychologicalServices.Data.EntityType.AssessmentTypeInvoiceAmountsEntity; }
		}
		#endregion
