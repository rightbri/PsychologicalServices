...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'AssessmentColor'.<br/><br/></summary>
	[Serializable]
	public partial class AssessmentColorEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "Assessment":
					...
					break;
				case "Color":
					toReturn.Add(Relations.ColorEntityUsingColorId);
					break;
				default:
					break;				
			}
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch the related entity of type 'Color' to this entity.</summary>
		/// <returns></returns>
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _assessment, new PropertyChangedEventHandler(OnAssessmentPropertyChanged), "Assessment", "AssessmentColors", PsychologicalServices.Data.RelationClasses.StaticAssessmentColorRelations.AssessmentEntityUsingAssessmentIdStatic, true, new int[] { (int)AssessmentColorFieldIndex.AssessmentId });
		}
		...
		{
			SetupSync(relatedEntity, ref _assessment, new PropertyChangedEventHandler( OnAssessmentPropertyChanged ), "Assessment", "AssessmentColors", PsychologicalServices.Data.RelationClasses.StaticAssessmentColorRelations.AssessmentEntityUsingAssessmentIdStatic, true, new string[] {  }, new int[] { (int)AssessmentColorFieldIndex.AssessmentId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _color, new PropertyChangedEventHandler(OnColorPropertyChanged), "Color", "AssessmentColors", PsychologicalServices.Data.RelationClasses.StaticAssessmentColorRelations.ColorEntityUsingColorIdStatic, true, new int[] { (int)AssessmentColorFieldIndex.ColorId });
		}

		/// <summary> setups the sync logic for member _color</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncColor(IEntityCore relatedEntity)
		{
			SetupSync(relatedEntity, ref _color, new PropertyChangedEventHandler( OnColorPropertyChanged ), "Color", "AssessmentColors", PsychologicalServices.Data.RelationClasses.StaticAssessmentColorRelations.ColorEntityUsingColorIdStatic, true, new string[] {  }, new int[] { (int)AssessmentColorFieldIndex.ColorId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AssessmentEntityFactory))),	(IEntityRelation)GetRelationsForField("Assessment")[0], (int)PsychologicalServices.Data.EntityType.AssessmentColorEntity, (int)PsychologicalServices.Data.EntityType.AssessmentEntity, 0, null, null, null, null, "Assessment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}

		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'Color' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathColor
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ColorEntityFactory))),	(IEntityRelation)GetRelationsForField("Color")[0], (int)PsychologicalServices.Data.EntityType.AssessmentColorEntity, (int)PsychologicalServices.Data.EntityType.ColorEntity, 0, null, null, null, null, "Color", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The AssessmentId property of the Entity AssessmentColor<br/><br/></summary>
		...
		/// <summary> The ColorId property of the Entity AssessmentColor<br/><br/></summary>
		...
		public virtual AssessmentEntity Assessment
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "AssessmentColors", "Assessment", _assessment, true); 
				}
			}
		}

		/// <summary> Gets / sets related entity of type 'ColorEntity' which has to be set using a fetch action earlier. If no related entity is set for this property, null is returned..<br/><br/></summary>
		[Browsable(true)]
		public virtual ColorEntity Color
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "AssessmentColors", "Color", _color, true); 
				}
			}
		}
