...
namespace PsychologicalServices.Data.EntityClasses
{
			...
			
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Contacts":
					toReturn.Add(Relations.ContactEntityUsingContactTypeId);
					break;
				default:
					break;				
			}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ContactEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ContactEntityFactory))), (IEntityRelation)GetRelationsForField("Contacts")[0], (int)PsychologicalServices.Data.EntityType.ContactTypeEntity, (int)PsychologicalServices.Data.EntityType.ContactEntity, 0, null, null, null, null, "Contacts", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <summary> The IsActive property of the Entity ContactType<br/><br/></summary>
		...
		{
			get { return GetOrCreateEntityCollection<ContactEntity, ContactEntityFactory>("ContactType", true, false, ref _contacts);	}
		}
