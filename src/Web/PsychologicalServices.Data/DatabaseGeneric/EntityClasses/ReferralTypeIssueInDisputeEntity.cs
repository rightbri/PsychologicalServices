			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_issueInDispute != null)
						{
							_issueInDispute.UnsetRelatedEntity(this, "ReferralTypeIssuesInDispute");
						}
					}
					else
					{
