...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'UserRole'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class UserRoleEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public UserRoleEntity(IEntityFields2 fields):base("UserRoleEntity")
		{
		...
		public UserRoleEntity(IValidator validator):base("UserRoleEntity")
		{
		...
		public UserRoleEntity(System.Int32 userId, System.Int32 roleId):base("UserRoleEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.UserId = userId;
			this.RoleId = roleId;
		...
		/// <param name="validator">The custom validator object for this UserRoleEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public UserRoleEntity(System.Int32 userId, System.Int32 roleId, IValidator validator):base("UserRoleEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.UserId = userId;
			this.RoleId = roleId;
		...
		{
			return UserRoleEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Role":
					toReturn.Add(UserRoleEntity.Relations.RoleEntityUsingRoleId);
					break;
				case "User":
					toReturn.Add(UserRoleEntity.Relations.UserEntityUsingUserId);
					break;
		...
		public bool TestOriginalFieldValueForNull(UserRoleFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(UserRoleFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(PsychologicalServices.Data.EntityType.UserRoleEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(UserRoleEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _role, new PropertyChangedEventHandler( OnRolePropertyChanged ), "Role", UserRoleEntity.Relations.RoleEntityUsingRoleId, true, signalRelatedEntity, "", resetFKFields, new int[] { (int)UserRoleFieldIndex.RoleId } );		
			_role = null;
		}
		...
		private void SetupSyncRole(IEntity2 relatedEntity)
		{
			if(_role!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _role, new PropertyChangedEventHandler( OnRolePropertyChanged ), "Role", UserRoleEntity.Relations.RoleEntityUsingRoleId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", UserRoleEntity.Relations.UserEntityUsingUserId, true, signalRelatedEntity, "UserRoles", resetFKFields, new int[] { (int)UserRoleFieldIndex.UserId } );		
			_user = null;
		}
		...
		private void SetupSyncUser(IEntity2 relatedEntity)
		{
			if(_user!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", UserRoleEntity.Relations.UserEntityUsingUserId, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathRole
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(RoleEntityFactory))),
					(IEntityRelation)GetRelationsForField("Role")[0], (int)PsychologicalServices.Data.EntityType.UserRoleEntity, (int)PsychologicalServices.Data.EntityType.RoleEntity, 0, null, null, null, null, "Role", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathUser
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),
					(IEntityRelation)GetRelationsForField("User")[0], (int)PsychologicalServices.Data.EntityType.UserRoleEntity, (int)PsychologicalServices.Data.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return UserRoleEntity.CustomProperties;}
		}
		...
		{
			get { return UserRoleEntity.FieldsCustomProperties;}
		}

		/// <summary> The UserId property of the Entity UserRole<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "UserRoles"."UserId"<br/>
		...
		/// <summary> The RoleId property of the Entity UserRole<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "UserRoles"."RoleId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
			...
			set
			{
				...
				else
				{
					...
					else
					{
						if(_role!=value)
						{
							SetRelatedEntity((IEntity2)value, "Role");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_user != null)
						{
							_user.UnsetRelatedEntity(this, "UserRoles");
						}
					}
					else
					{
						if(_user!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "UserRoles");
						}
					}
				}
			}
		...
		{ 
			get { return (int)PsychologicalServices.Data.EntityType.UserRoleEntity; }
		}
		#endregion
