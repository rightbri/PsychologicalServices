...
namespace PsychologicalServices.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _role, new PropertyChangedEventHandler(OnRolePropertyChanged), "Role", "UserRoles", PsychologicalServices.Data.RelationClasses.StaticUserRoleRelations.RoleEntityUsingRoleIdStatic, true, new int[] { (int)UserRoleFieldIndex.RoleId });
		}
		...
		{
			SetupSync(relatedEntity, ref _role, new PropertyChangedEventHandler( OnRolePropertyChanged ), "Role", "UserRoles", PsychologicalServices.Data.RelationClasses.StaticUserRoleRelations.RoleEntityUsingRoleIdStatic, true, new string[] {  }, new int[] { (int)UserRoleFieldIndex.RoleId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _user, new PropertyChangedEventHandler(OnUserPropertyChanged), "User", "UserRoles", PsychologicalServices.Data.RelationClasses.StaticUserRoleRelations.UserEntityUsingUserIdStatic, true, new int[] { (int)UserRoleFieldIndex.UserId });
		}
		...
		{
			SetupSync(relatedEntity, ref _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", "UserRoles", PsychologicalServices.Data.RelationClasses.StaticUserRoleRelations.UserEntityUsingUserIdStatic, true, new string[] {  }, new int[] { (int)UserRoleFieldIndex.UserId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(RoleEntityFactory))),	(IEntityRelation)GetRelationsForField("Role")[0], (int)PsychologicalServices.Data.EntityType.UserRoleEntity, (int)PsychologicalServices.Data.EntityType.RoleEntity, 0, null, null, null, null, "Role", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("User")[0], (int)PsychologicalServices.Data.EntityType.UserRoleEntity, (int)PsychologicalServices.Data.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual UserEntity User
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "UserRoles", "User", _user, true); 
				}
			}
		}
