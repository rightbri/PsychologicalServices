...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'InvoiceAppointment'.<br/><br/></summary>
	[Serializable]
	public partial class InvoiceAppointmentEntity : CommonEntityBase
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _appointment, new PropertyChangedEventHandler(OnAppointmentPropertyChanged), "Appointment", "", PsychologicalServices.Data.RelationClasses.StaticInvoiceAppointmentRelations.AppointmentEntityUsingAppointmentIdStatic, true, new int[] { (int)InvoiceAppointmentFieldIndex.AppointmentId });
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _invoice, new PropertyChangedEventHandler(OnInvoicePropertyChanged), "Invoice", "InvoiceAppointments", PsychologicalServices.Data.RelationClasses.StaticInvoiceAppointmentRelations.InvoiceEntityUsingInvoiceIdStatic, true, new int[] { (int)InvoiceAppointmentFieldIndex.InvoiceId });
		}
		...
		{
			SetupSync(relatedEntity, ref _invoice, new PropertyChangedEventHandler( OnInvoicePropertyChanged ), "Invoice", "InvoiceAppointments", PsychologicalServices.Data.RelationClasses.StaticInvoiceAppointmentRelations.InvoiceEntityUsingInvoiceIdStatic, true, new string[] {  }, new int[] { (int)InvoiceAppointmentFieldIndex.InvoiceId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AppointmentEntityFactory))),	(IEntityRelation)GetRelationsForField("Appointment")[0], (int)PsychologicalServices.Data.EntityType.InvoiceAppointmentEntity, (int)PsychologicalServices.Data.EntityType.AppointmentEntity, 0, null, null, null, null, "Appointment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The InvoiceAppointmentId property of the Entity InvoiceAppointment<br/><br/></summary>
		...
		/// <summary> The InvoiceId property of the Entity InvoiceAppointment<br/><br/></summary>
		...
		/// <summary> The AppointmentId property of the Entity InvoiceAppointment<br/><br/></summary>
		...
		public virtual AppointmentEntity Appointment
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "", "Appointment", _appointment, false); 
				}
			}
		}
		...
		public virtual InvoiceEntity Invoice
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "InvoiceAppointments", "Invoice", _invoice, true); 
				}
			}
		}
