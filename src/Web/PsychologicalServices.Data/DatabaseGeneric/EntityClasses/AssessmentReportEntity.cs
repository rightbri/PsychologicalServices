...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'AssessmentReport'.<br/><br/></summary>
	[Serializable]
	public partial class AssessmentReportEntity : CommonEntityBase
			...
			
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "Assessment":
					...
					break;
				case "ReportType":
					toReturn.Add(Relations.ReportTypeEntityUsingReportTypeId);
					break;
				case "AssessmentReportIssuesInDispute":
					toReturn.Add(Relations.AssessmentReportIssueInDisputeEntityUsingReportId);
					break;
				default:
					break;				
			}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _assessment, new PropertyChangedEventHandler(OnAssessmentPropertyChanged), "Assessment", "AssessmentReports", PsychologicalServices.Data.RelationClasses.StaticAssessmentReportRelations.AssessmentEntityUsingAssessmentIdStatic, true, new int[] { (int)AssessmentReportFieldIndex.AssessmentId });
		}
		...
		{
			SetupSync(relatedEntity, ref _assessment, new PropertyChangedEventHandler( OnAssessmentPropertyChanged ), "Assessment", "AssessmentReports", PsychologicalServices.Data.RelationClasses.StaticAssessmentReportRelations.AssessmentEntityUsingAssessmentIdStatic, true, new string[] {  }, new int[] { (int)AssessmentReportFieldIndex.AssessmentId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _reportType, new PropertyChangedEventHandler(OnReportTypePropertyChanged), "ReportType", "AssessmentReports", PsychologicalServices.Data.RelationClasses.StaticAssessmentReportRelations.ReportTypeEntityUsingReportTypeIdStatic, true, new int[] { (int)AssessmentReportFieldIndex.ReportTypeId });
		}

		/// <summary> setups the sync logic for member _reportType</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncReportType(IEntityCore relatedEntity)
		{
			SetupSync(relatedEntity, ref _reportType, new PropertyChangedEventHandler( OnReportTypePropertyChanged ), "ReportType", "AssessmentReports", PsychologicalServices.Data.RelationClasses.StaticAssessmentReportRelations.ReportTypeEntityUsingReportTypeIdStatic, true, new string[] {  }, new int[] { (int)AssessmentReportFieldIndex.ReportTypeId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AssessmentReportIssueInDisputeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AssessmentReportIssueInDisputeEntityFactory))), (IEntityRelation)GetRelationsForField("AssessmentReportIssuesInDispute")[0], (int)PsychologicalServices.Data.EntityType.AssessmentReportEntity, (int)PsychologicalServices.Data.EntityType.AssessmentReportIssueInDisputeEntity, 0, null, null, null, null, "AssessmentReportIssuesInDispute", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AssessmentEntityFactory))),	(IEntityRelation)GetRelationsForField("Assessment")[0], (int)PsychologicalServices.Data.EntityType.AssessmentReportEntity, (int)PsychologicalServices.Data.EntityType.AssessmentEntity, 0, null, null, null, null, "Assessment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ReportTypeEntityFactory))),	(IEntityRelation)GetRelationsForField("ReportType")[0], (int)PsychologicalServices.Data.EntityType.AssessmentReportEntity, (int)PsychologicalServices.Data.EntityType.ReportTypeEntity, 0, null, null, null, null, "ReportType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The ReportId property of the Entity AssessmentReport<br/><br/></summary>
		...
		/// <summary> The AssessmentId property of the Entity AssessmentReport<br/><br/></summary>
		...
		/// <summary> The ReportTypeId property of the Entity AssessmentReport<br/><br/></summary>
		...
		/// <summary> The IsAdditional property of the Entity AssessmentReport<br/><br/></summary>
		...
		{
			get { return GetOrCreateEntityCollection<AssessmentReportIssueInDisputeEntity, AssessmentReportIssueInDisputeEntityFactory>("AssessmentReport", true, false, ref _assessmentReportIssuesInDispute);	}
		}
		...
		public virtual AssessmentEntity Assessment
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "AssessmentReports", "Assessment", _assessment, true); 
				}
			}
		}

		/// <summary> Gets / sets related entity of type 'ReportTypeEntity' which has to be set using a fetch action earlier. If no related entity is set for this property, null is returned..<br/><br/></summary>
		[Browsable(true)]
		public virtual ReportTypeEntity ReportType
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "AssessmentReports", "ReportType", _reportType, true); 
				}
			}
		}
