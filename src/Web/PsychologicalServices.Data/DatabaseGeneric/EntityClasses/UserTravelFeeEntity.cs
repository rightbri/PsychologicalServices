...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'UserTravelFee'.<br/><br/></summary>
	[Serializable]
	public partial class UserTravelFeeEntity : CommonEntityBase
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _city, new PropertyChangedEventHandler(OnCityPropertyChanged), "City", "UserTravelFees", PsychologicalServices.Data.RelationClasses.StaticUserTravelFeeRelations.CityEntityUsingCityIdStatic, true, new int[] { (int)UserTravelFeeFieldIndex.CityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _city, new PropertyChangedEventHandler( OnCityPropertyChanged ), "City", "UserTravelFees", PsychologicalServices.Data.RelationClasses.StaticUserTravelFeeRelations.CityEntityUsingCityIdStatic, true, new string[] {  }, new int[] { (int)UserTravelFeeFieldIndex.CityId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _user, new PropertyChangedEventHandler(OnUserPropertyChanged), "User", "UserTravelFees", PsychologicalServices.Data.RelationClasses.StaticUserTravelFeeRelations.UserEntityUsingUserIdStatic, true, new int[] { (int)UserTravelFeeFieldIndex.UserId });
		}
		...
		{
			SetupSync(relatedEntity, ref _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", "UserTravelFees", PsychologicalServices.Data.RelationClasses.StaticUserTravelFeeRelations.UserEntityUsingUserIdStatic, true, new string[] {  }, new int[] { (int)UserTravelFeeFieldIndex.UserId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CityEntityFactory))),	(IEntityRelation)GetRelationsForField("City")[0], (int)PsychologicalServices.Data.EntityType.UserTravelFeeEntity, (int)PsychologicalServices.Data.EntityType.CityEntity, 0, null, null, null, null, "City", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("User")[0], (int)PsychologicalServices.Data.EntityType.UserTravelFeeEntity, (int)PsychologicalServices.Data.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The UserId property of the Entity UserTravelFee<br/><br/></summary>
		...
		/// <summary> The CityId property of the Entity UserTravelFee<br/><br/></summary>
		...
		/// <summary> The Amount property of the Entity UserTravelFee<br/><br/></summary>
		...
		public virtual CityEntity City
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "UserTravelFees", "City", _city, true); 
				}
			}
		}
		...
		public virtual UserEntity User
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "UserTravelFees", "User", _user, true); 
				}
			}
		}
