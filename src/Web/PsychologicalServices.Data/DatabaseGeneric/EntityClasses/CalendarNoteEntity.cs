...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'CalendarNote'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class CalendarNoteEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static CalendarNoteEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public CalendarNoteEntity():base("CalendarNoteEntity")
		{
		...
		public CalendarNoteEntity(IEntityFields2 fields):base("CalendarNoteEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this CalendarNoteEntity</param>
		public CalendarNoteEntity(IValidator validator):base("CalendarNoteEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="calendarNoteId">PK value for CalendarNote which data should be fetched into this CalendarNote object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public CalendarNoteEntity(System.Int32 calendarNoteId):base("CalendarNoteEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this CalendarNoteEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public CalendarNoteEntity(System.Int32 calendarNoteId, IValidator validator):base("CalendarNoteEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.CalendarNoteId = calendarNoteId;
		}
		...
		protected CalendarNoteEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((CalendarNoteFieldIndex)fieldIndex)
			{
		...
		{
			return CalendarNoteEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(CalendarNoteFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(CalendarNoteFieldIndex fieldIndex)
		{
		...
		{
			return new CalendarNoteRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(PsychologicalServices.Data.EntityType.CalendarNoteEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(CalendarNoteEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("CalendarNoteId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			base.PerformDesetupSyncRelatedEntity( _note, new PropertyChangedEventHandler( OnNotePropertyChanged ), "Note", CalendarNoteEntity.Relations.NoteEntityUsingNoteId, true, signalRelatedEntity, "CalendarNote", resetFKFields, new int[] { (int)CalendarNoteFieldIndex.NoteId } );		
			_note = null;
		}
		...
		private void SetupSyncNote(IEntity2 relatedEntity)
		{
			if(_note!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _note, new PropertyChangedEventHandler( OnNotePropertyChanged ), "Note", CalendarNoteEntity.Relations.NoteEntityUsingNoteId, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this CalendarNoteEntity</param>
		...
		public  static CalendarNoteRelations Relations
		{
			get	{ return new CalendarNoteRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathNote
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(NoteEntityFactory))),
					(IEntityRelation)GetRelationsForField("Note")[0], (int)PsychologicalServices.Data.EntityType.CalendarNoteEntity, (int)PsychologicalServices.Data.EntityType.NoteEntity, 0, null, null, null, null, "Note", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return CalendarNoteEntity.CustomProperties;}
		}
		...
		{
			get { return CalendarNoteEntity.FieldsCustomProperties;}
		}

		/// <summary> The CalendarNoteId property of the Entity CalendarNote<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "CalendarNotes"."CalendarNoteId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 CalendarNoteId
		{
			get { return (System.Int32)GetValue((int)CalendarNoteFieldIndex.CalendarNoteId, true); }
			set	{ SetValue((int)CalendarNoteFieldIndex.CalendarNoteId, value); }
		}
		...
		/// <summary> The NoteId property of the Entity CalendarNote<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "CalendarNotes"."NoteId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 NoteId
		{
			get { return (System.Int32)GetValue((int)CalendarNoteFieldIndex.NoteId, true); }
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_note != null)
						{
							_note.UnsetRelatedEntity(this, "CalendarNote");
						}
					}
					else
					{
						if(_note!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "CalendarNote");
						}
					}
				}
			}
		...
		{ 
			get { return (int)PsychologicalServices.Data.EntityType.CalendarNoteEntity; }
		}
		#endregion
