...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'CalendarNote'.<br/><br/></summary>
	[Serializable]
	public partial class CalendarNoteEntity : CommonEntityBase
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _company, new PropertyChangedEventHandler(OnCompanyPropertyChanged), "Company", "", PsychologicalServices.Data.RelationClasses.StaticCalendarNoteRelations.CompanyEntityUsingCompanyIdStatic, true, new int[] { (int)CalendarNoteFieldIndex.CompanyId });
		}
		...
		{
			SetupSync(relatedEntity, ref _company, new PropertyChangedEventHandler( OnCompanyPropertyChanged ), "Company", "", PsychologicalServices.Data.RelationClasses.StaticCalendarNoteRelations.CompanyEntityUsingCompanyIdStatic, true, new string[] {  }, new int[] { (int)CalendarNoteFieldIndex.CompanyId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _note, new PropertyChangedEventHandler(OnNotePropertyChanged), "Note", "CalendarNote", PsychologicalServices.Data.RelationClasses.StaticCalendarNoteRelations.NoteEntityUsingNoteIdStatic, true, new int[] { (int)CalendarNoteFieldIndex.NoteId });
		}
		...
		{
			SetupSync(relatedEntity, ref _note, new PropertyChangedEventHandler( OnNotePropertyChanged ), "Note", "CalendarNote", PsychologicalServices.Data.RelationClasses.StaticCalendarNoteRelations.NoteEntityUsingNoteIdStatic, true, new string[] {  }, new int[] { (int)CalendarNoteFieldIndex.NoteId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(NoteEntityFactory))),	(IEntityRelation)GetRelationsForField("Note")[0], (int)PsychologicalServices.Data.EntityType.CalendarNoteEntity, (int)PsychologicalServices.Data.EntityType.NoteEntity, 0, null, null, null, null, "Note", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The CalendarNoteId property of the Entity CalendarNote<br/><br/></summary>
		...
		/// <summary> The FromDate property of the Entity CalendarNote<br/><br/></summary>
		...
		/// <summary> The ToDate property of the Entity CalendarNote<br/><br/></summary>
		...
		/// <summary> The NoteId property of the Entity CalendarNote<br/><br/></summary>
		...
		/// <summary> The CompanyId property of the Entity CalendarNote<br/><br/></summary>
		...
		public virtual CompanyEntity Company
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "", "Company", _company, false); 
				}
			}
		}
		...
		public virtual NoteEntity Note
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "CalendarNote", "Note", _note, true); 
				}
			}
		}
