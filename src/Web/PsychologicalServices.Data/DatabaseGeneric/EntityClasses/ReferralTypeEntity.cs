...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'ReferralType'.<br/><br/></summary>
	[Serializable]
	public partial class ReferralTypeEntity : CommonEntityBase
			...
			
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Assessments":
					toReturn.Add(Relations.AssessmentEntityUsingReferralTypeId);
					break;
				case "ReferralTypeIssuesInDispute":
					toReturn.Add(Relations.ReferralTypeIssueInDisputeEntityUsingReferralTypeId);
					break;
				default:
					break;				
			}
		...
		/// <summary> The ReferralTypeId property of the Entity ReferralType<br/><br/></summary>
		...
		/// <summary> The Name property of the Entity ReferralType<br/><br/></summary>
		...
		/// <summary> The IsActive property of the Entity ReferralType<br/><br/></summary>
		...
		{
			get { return GetOrCreateEntityCollection<AssessmentEntity, AssessmentEntityFactory>("ReferralType", true, false, ref _assessments);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<ReferralTypeIssueInDisputeEntity, ReferralTypeIssueInDisputeEntityFactory>("ReferralType", true, false, ref _referralTypeIssuesInDispute);	}
		}
