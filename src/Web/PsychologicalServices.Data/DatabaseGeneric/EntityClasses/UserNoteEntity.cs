...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'UserNote'.<br/><br/></summary>
	[Serializable]
	public partial class UserNoteEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _note, new PropertyChangedEventHandler(OnNotePropertyChanged), "Note", "UserNotes", PsychologicalServices.Data.RelationClasses.StaticUserNoteRelations.NoteEntityUsingNoteIdStatic, true, new int[] { (int)UserNoteFieldIndex.NoteId });
		}
		...
		{
			SetupSync(relatedEntity, ref _note, new PropertyChangedEventHandler( OnNotePropertyChanged ), "Note", "UserNotes", PsychologicalServices.Data.RelationClasses.StaticUserNoteRelations.NoteEntityUsingNoteIdStatic, true, new string[] {  }, new int[] { (int)UserNoteFieldIndex.NoteId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _user, new PropertyChangedEventHandler(OnUserPropertyChanged), "User", "UserNotes", PsychologicalServices.Data.RelationClasses.StaticUserNoteRelations.UserEntityUsingUserIdStatic, true, new int[] { (int)UserNoteFieldIndex.UserId });
		}
		...
		{
			SetupSync(relatedEntity, ref _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", "UserNotes", PsychologicalServices.Data.RelationClasses.StaticUserNoteRelations.UserEntityUsingUserIdStatic, true, new string[] {  }, new int[] { (int)UserNoteFieldIndex.UserId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(NoteEntityFactory))),	(IEntityRelation)GetRelationsForField("Note")[0], (int)PsychologicalServices.Data.EntityType.UserNoteEntity, (int)PsychologicalServices.Data.EntityType.NoteEntity, 0, null, null, null, null, "Note", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("User")[0], (int)PsychologicalServices.Data.EntityType.UserNoteEntity, (int)PsychologicalServices.Data.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The NoteId property of the Entity UserNote<br/><br/></summary>
		...
		/// <summary> The UserId property of the Entity UserNote<br/><br/></summary>
		...
		public virtual NoteEntity Note
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "UserNotes", "Note", _note, true); 
				}
			}
		}
		...
		public virtual UserEntity User
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "UserNotes", "User", _user, true); 
				}
			}
		}
