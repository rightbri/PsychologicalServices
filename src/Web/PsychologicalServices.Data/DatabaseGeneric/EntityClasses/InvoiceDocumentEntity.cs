...
namespace PsychologicalServices.Data.EntityClasses
{
			...
			
	{
		...
		/// <summary> CTor</summary>
		/// <param name="invoiceId">PK value for InvoiceDocument which data should be fetched into this InvoiceDocument object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public InvoiceDocumentEntity(System.Int32 invoiceId):base("InvoiceDocumentEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this InvoiceDocumentEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public InvoiceDocumentEntity(System.Int32 invoiceId, IValidator validator):base("InvoiceDocumentEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.InvoiceId = invoiceId;
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _invoice, new PropertyChangedEventHandler( OnInvoicePropertyChanged ), "Invoice", InvoiceDocumentEntity.Relations.InvoiceEntityUsingInvoiceId, true, signalRelatedEntity, "InvoiceDocument", false, new int[] { (int)InvoiceDocumentFieldIndex.InvoiceId } );
			_invoice = null;
		}
		...
		public static IPrefetchPathElement2 PrefetchPathInvoice
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(InvoiceEntityFactory))),
					(IEntityRelation)GetRelationsForField("Invoice")[0], (int)PsychologicalServices.Data.EntityType.InvoiceDocumentEntity, (int)PsychologicalServices.Data.EntityType.InvoiceEntity, 0, null, null, null, null, "Invoice", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);
			}
		}
		...
		/// <summary> The CreatedDate property of the Entity InvoiceDocument<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "InvoiceDocuments"."CreatedDate"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime CreatedDate
		{
			get { return (System.DateTime)GetValue((int)InvoiceDocumentFieldIndex.CreatedDate, true); }
			set	{ SetValue((int)InvoiceDocumentFieldIndex.CreatedDate, value); }
		}
		...
		public virtual InvoiceEntity Invoice
		{
			...
			set
			{
				if(base.IsDeserializing)
				{
					...
					{
						value.SetRelatedEntity(this, "InvoiceDocument");
					}
				}
				else
				{
					...
					else
					{
						if(_invoice!=value)
						{
							...
							relatedEntity.SetRelatedEntity(this, "InvoiceDocument");
							SetupSyncInvoice(relatedEntity);
						}
					}
				}
