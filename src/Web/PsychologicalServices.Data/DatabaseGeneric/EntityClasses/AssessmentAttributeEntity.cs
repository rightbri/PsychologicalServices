...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'AssessmentAttribute'.<br/><br/></summary>
	[Serializable]
	public partial class AssessmentAttributeEntity : CommonEntityBase
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _assessment, new PropertyChangedEventHandler(OnAssessmentPropertyChanged), "Assessment", "AssessmentAttributes", PsychologicalServices.Data.RelationClasses.StaticAssessmentAttributeRelations.AssessmentEntityUsingAssessmentIdStatic, true, new int[] { (int)AssessmentAttributeFieldIndex.AssessmentId });
		}
		...
		{
			SetupSync(relatedEntity, ref _assessment, new PropertyChangedEventHandler( OnAssessmentPropertyChanged ), "Assessment", "AssessmentAttributes", PsychologicalServices.Data.RelationClasses.StaticAssessmentAttributeRelations.AssessmentEntityUsingAssessmentIdStatic, true, new string[] {  }, new int[] { (int)AssessmentAttributeFieldIndex.AssessmentId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _attribute, new PropertyChangedEventHandler(OnAttributePropertyChanged), "Attribute", "AssessmentAttributes", PsychologicalServices.Data.RelationClasses.StaticAssessmentAttributeRelations.AttributeEntityUsingAttributeIdStatic, true, new int[] { (int)AssessmentAttributeFieldIndex.AttributeId });
		}
		...
		{
			SetupSync(relatedEntity, ref _attribute, new PropertyChangedEventHandler( OnAttributePropertyChanged ), "Attribute", "AssessmentAttributes", PsychologicalServices.Data.RelationClasses.StaticAssessmentAttributeRelations.AttributeEntityUsingAttributeIdStatic, true, new string[] {  }, new int[] { (int)AssessmentAttributeFieldIndex.AttributeId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AssessmentEntityFactory))),	(IEntityRelation)GetRelationsForField("Assessment")[0], (int)PsychologicalServices.Data.EntityType.AssessmentAttributeEntity, (int)PsychologicalServices.Data.EntityType.AssessmentEntity, 0, null, null, null, null, "Assessment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AttributeEntityFactory))),	(IEntityRelation)GetRelationsForField("Attribute")[0], (int)PsychologicalServices.Data.EntityType.AssessmentAttributeEntity, (int)PsychologicalServices.Data.EntityType.AttributeEntity, 0, null, null, null, null, "Attribute", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The AssessmentId property of the Entity AssessmentAttribute<br/><br/></summary>
		...
		/// <summary> The AttributeId property of the Entity AssessmentAttribute<br/><br/></summary>
		...
		/// <summary> The Value property of the Entity AssessmentAttribute<br/><br/></summary>
		...
		public virtual AssessmentEntity Assessment
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "AssessmentAttributes", "Assessment", _assessment, true); 
				}
			}
		}
		...
		public virtual AttributeEntity Attribute
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "AssessmentAttributes", "Attribute", _attribute, true); 
				}
			}
		}
