...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'AddressAddressType'.<br/><br/></summary>
	[Serializable]
	public partial class AddressAddressTypeEntity : CommonEntityBase
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _address, new PropertyChangedEventHandler(OnAddressPropertyChanged), "Address", "AddressAddressTypes", PsychologicalServices.Data.RelationClasses.StaticAddressAddressTypeRelations.AddressEntityUsingAddressIdStatic, true, new int[] { (int)AddressAddressTypeFieldIndex.AddressId });
		}
		...
		{
			SetupSync(relatedEntity, ref _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", "AddressAddressTypes", PsychologicalServices.Data.RelationClasses.StaticAddressAddressTypeRelations.AddressEntityUsingAddressIdStatic, true, new string[] {  }, new int[] { (int)AddressAddressTypeFieldIndex.AddressId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _addressType, new PropertyChangedEventHandler(OnAddressTypePropertyChanged), "AddressType", "AddressAddressTypes", PsychologicalServices.Data.RelationClasses.StaticAddressAddressTypeRelations.AddressTypeEntityUsingAddressTypeIdStatic, true, new int[] { (int)AddressAddressTypeFieldIndex.AddressTypeId });
		}
		...
		{
			SetupSync(relatedEntity, ref _addressType, new PropertyChangedEventHandler( OnAddressTypePropertyChanged ), "AddressType", "AddressAddressTypes", PsychologicalServices.Data.RelationClasses.StaticAddressAddressTypeRelations.AddressTypeEntityUsingAddressTypeIdStatic, true, new string[] {  }, new int[] { (int)AddressAddressTypeFieldIndex.AddressTypeId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AddressEntityFactory))),	(IEntityRelation)GetRelationsForField("Address")[0], (int)PsychologicalServices.Data.EntityType.AddressAddressTypeEntity, (int)PsychologicalServices.Data.EntityType.AddressEntity, 0, null, null, null, null, "Address", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AddressTypeEntityFactory))),	(IEntityRelation)GetRelationsForField("AddressType")[0], (int)PsychologicalServices.Data.EntityType.AddressAddressTypeEntity, (int)PsychologicalServices.Data.EntityType.AddressTypeEntity, 0, null, null, null, null, "AddressType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The AddressId property of the Entity AddressAddressType<br/><br/></summary>
		...
		/// <summary> The AddressTypeId property of the Entity AddressAddressType<br/><br/></summary>
		...
		public virtual AddressEntity Address
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "AddressAddressTypes", "Address", _address, true); 
				}
			}
		}
		...
		public virtual AddressTypeEntity AddressType
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "AddressAddressTypes", "AddressType", _addressType, true); 
				}
			}
		}
