...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'InvoiceStatusPaths'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class InvoiceStatusPathsEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return InvoiceStatusPathsEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "NextInvoiceStatus":
					toReturn.Add(InvoiceStatusPathsEntity.Relations.InvoiceStatusEntityUsingNextInvoiceStatusId);
					break;
				case "InvoiceStatus":
					toReturn.Add(InvoiceStatusPathsEntity.Relations.InvoiceStatusEntityUsingInvoiceStatusId);
					break;
		...
		public bool TestOriginalFieldValueForNull(InvoiceStatusPathsFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(InvoiceStatusPathsFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(PsychologicalServices.Data.EntityType.InvoiceStatusPathsEntity);
		}
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_nextInvoiceStatus!=null)
			{
				_nextInvoiceStatus.ActiveContext = base.ActiveContext;
			}
			if(_invoiceStatus!=null)
			{
		...
		{
			base.PerformDesetupSyncRelatedEntity( _nextInvoiceStatus, new PropertyChangedEventHandler( OnNextInvoiceStatusPropertyChanged ), "NextInvoiceStatus", InvoiceStatusPathsEntity.Relations.InvoiceStatusEntityUsingNextInvoiceStatusId, true, signalRelatedEntity, "NextInvoiceStatusPaths", resetFKFields, new int[] { (int)InvoiceStatusPathsFieldIndex.NextInvoiceStatusId } );		
			_nextInvoiceStatus = null;
		}

		/// <summary> setups the sync logic for member _nextInvoiceStatus</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncNextInvoiceStatus(IEntity2 relatedEntity)
		{
			if(_nextInvoiceStatus!=relatedEntity)
			{
				DesetupSyncNextInvoiceStatus(true, true);
				_nextInvoiceStatus = (InvoiceStatusEntity)relatedEntity;
				base.PerformSetupSyncRelatedEntity( _nextInvoiceStatus, new PropertyChangedEventHandler( OnNextInvoiceStatusPropertyChanged ), "NextInvoiceStatus", InvoiceStatusPathsEntity.Relations.InvoiceStatusEntityUsingNextInvoiceStatusId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _invoiceStatus, new PropertyChangedEventHandler( OnInvoiceStatusPropertyChanged ), "InvoiceStatus", InvoiceStatusPathsEntity.Relations.InvoiceStatusEntityUsingInvoiceStatusId, true, signalRelatedEntity, "InvoiceStatusPaths", resetFKFields, new int[] { (int)InvoiceStatusPathsFieldIndex.InvoiceStatusId } );		
			_invoiceStatus = null;
		}
		...
		private void SetupSyncInvoiceStatus(IEntity2 relatedEntity)
		{
			if(_invoiceStatus!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _invoiceStatus, new PropertyChangedEventHandler( OnInvoiceStatusPropertyChanged ), "InvoiceStatus", InvoiceStatusPathsEntity.Relations.InvoiceStatusEntityUsingInvoiceStatusId, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathNextInvoiceStatus
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(InvoiceStatusEntityFactory))),
					(IEntityRelation)GetRelationsForField("NextInvoiceStatus")[0], (int)PsychologicalServices.Data.EntityType.InvoiceStatusPathsEntity, (int)PsychologicalServices.Data.EntityType.InvoiceStatusEntity, 0, null, null, null, null, "NextInvoiceStatus", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathInvoiceStatus
		{
			...
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(InvoiceStatusEntityFactory))),
					(IEntityRelation)GetRelationsForField("InvoiceStatus")[0], (int)PsychologicalServices.Data.EntityType.InvoiceStatusPathsEntity, (int)PsychologicalServices.Data.EntityType.InvoiceStatusEntity, 0, null, null, null, null, "InvoiceStatus", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return InvoiceStatusPathsEntity.CustomProperties;}
		}
		...
		{
			get { return InvoiceStatusPathsEntity.FieldsCustomProperties;}
		}

		/// <summary> The InvoiceStatusPathId property of the Entity InvoiceStatusPaths<br/><br/>
		/// </summary>
		...
		/// <summary> The InvoiceStatusId property of the Entity InvoiceStatusPaths<br/><br/>
		/// </summary>
		...
		/// <summary> The NextInvoiceStatusId property of the Entity InvoiceStatusPaths<br/><br/>
		/// </summary>
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_nextInvoiceStatus != null)
						{
							_nextInvoiceStatus.UnsetRelatedEntity(this, "NextInvoiceStatusPaths");
						}
					}
					else
					{
						if(_nextInvoiceStatus!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "NextInvoiceStatusPaths");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_invoiceStatus != null)
						{
							_invoiceStatus.UnsetRelatedEntity(this, "InvoiceStatusPaths");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "InvoiceStatusPaths");
						}
					}
				}
			}
