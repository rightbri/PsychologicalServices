...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'InvoiceLineGroupArbitration'.<br/><br/></summary>
	[Serializable]
	public partial class InvoiceLineGroupArbitrationEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _arbitration, new PropertyChangedEventHandler(OnArbitrationPropertyChanged), "Arbitration", "InvoiceLineGroupArbitrations", PsychologicalServices.Data.RelationClasses.StaticInvoiceLineGroupArbitrationRelations.ArbitrationEntityUsingArbitrationIdStatic, true, new int[] { (int)InvoiceLineGroupArbitrationFieldIndex.ArbitrationId });
		}
		...
		{
			SetupSync(relatedEntity, ref _arbitration, new PropertyChangedEventHandler( OnArbitrationPropertyChanged ), "Arbitration", "InvoiceLineGroupArbitrations", PsychologicalServices.Data.RelationClasses.StaticInvoiceLineGroupArbitrationRelations.ArbitrationEntityUsingArbitrationIdStatic, true, new string[] {  }, new int[] { (int)InvoiceLineGroupArbitrationFieldIndex.ArbitrationId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _invoiceLineGroup, new PropertyChangedEventHandler(OnInvoiceLineGroupPropertyChanged), "InvoiceLineGroup", "InvoiceLineGroupArbitration", PsychologicalServices.Data.RelationClasses.StaticInvoiceLineGroupArbitrationRelations.InvoiceLineGroupEntityUsingInvoiceLineGroupIdStatic, true, new int[] { (int)InvoiceLineGroupArbitrationFieldIndex.InvoiceLineGroupId });
		}
		...
		{
			SetupSync(relatedEntity, ref _invoiceLineGroup, new PropertyChangedEventHandler( OnInvoiceLineGroupPropertyChanged ), "InvoiceLineGroup", "InvoiceLineGroupArbitration", PsychologicalServices.Data.RelationClasses.StaticInvoiceLineGroupArbitrationRelations.InvoiceLineGroupEntityUsingInvoiceLineGroupIdStatic, true, new string[] {  }, new int[] { (int)InvoiceLineGroupArbitrationFieldIndex.InvoiceLineGroupId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ArbitrationEntityFactory))),	(IEntityRelation)GetRelationsForField("Arbitration")[0], (int)PsychologicalServices.Data.EntityType.InvoiceLineGroupArbitrationEntity, (int)PsychologicalServices.Data.EntityType.ArbitrationEntity, 0, null, null, null, null, "Arbitration", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(InvoiceLineGroupEntityFactory))), (IEntityRelation)GetRelationsForField("InvoiceLineGroup")[0], (int)PsychologicalServices.Data.EntityType.InvoiceLineGroupArbitrationEntity, (int)PsychologicalServices.Data.EntityType.InvoiceLineGroupEntity, 0, null, null, null, null, "InvoiceLineGroup", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		/// <summary> The InvoiceLineGroupId property of the Entity InvoiceLineGroupArbitration<br/><br/></summary>
		...
		/// <summary> The ArbitrationId property of the Entity InvoiceLineGroupArbitration<br/><br/></summary>
		...
		public virtual ArbitrationEntity Arbitration
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "InvoiceLineGroupArbitrations", "Arbitration", _arbitration, true); 
				}
			}
		}
		...
		public virtual InvoiceLineGroupEntity InvoiceLineGroup
		{
			...
			set
			{
				if(this.IsDeserializing)
				{
					...
					CallSetRelatedEntityDuringDeserialization(value, "InvoiceLineGroupArbitration");
				}
				else
				{
					if(value==null)
					...
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "InvoiceLineGroupArbitration");
							SetupSyncInvoiceLineGroup(value);
						}
					}
				}
