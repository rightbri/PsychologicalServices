...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'IssueInDispute'.<br/><br/></summary>
	[Serializable]
	public partial class IssueInDisputeEntity : CommonEntityBase
			...
			
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "AssessmentReportIssuesInDispute":
					toReturn.Add(Relations.AssessmentReportIssueInDisputeEntityUsingIssueInDisputeId);
					break;
				case "ReportTypeInvoiceAmount":
					toReturn.Add(Relations.IssueInDisputeInvoiceAmountEntityUsingIssueInDisputeId);
					break;
				case "ReferralTypeIssuesInDispute":
					toReturn.Add(Relations.ReferralTypeIssueInDisputeEntityUsingIssueInDisputeId);
					break;
				case "CompanyCollectionViaReportTypeInvoiceAmount":
					toReturn.Add(Relations.IssueInDisputeInvoiceAmountEntityUsingIssueInDisputeId, "IssueInDisputeEntity__", "IssueInDisputeInvoiceAmount_", JoinHint.None);
		...
		protected override void UnsetRelatedEntity(IEntityCore relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			...
			{
				case "AssessmentReportIssuesInDispute":
					this.PerformRelatedEntityRemoval(this.AssessmentReportIssuesInDispute, relatedEntity, signalRelatedEntityManyToOne);
					break;
				case "ReportTypeInvoiceAmount":
					this.PerformRelatedEntityRemoval(this.ReportTypeInvoiceAmount, relatedEntity, signalRelatedEntityManyToOne);
					break;
				case "ReferralTypeIssuesInDispute":
					this.PerformRelatedEntityRemoval(this.ReferralTypeIssuesInDispute, relatedEntity, signalRelatedEntityManyToOne);
					break;
				default:
					break;
			}
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch the related entities of type 'AssessmentReportIssueInDispute' to this entity.</summary>
		/// <returns></returns>
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch the related entities of type 'ReferralTypeIssueInDispute' to this entity.</summary>
		/// <returns></returns>
		...
		{
			bool toReturn = false;
			toReturn |=(this._assessmentReportIssuesInDispute != null);
			toReturn |=(this._reportTypeInvoiceAmount != null);
			toReturn |=(this._referralTypeIssuesInDispute != null);
			toReturn |= (this._companyCollectionViaReportTypeInvoiceAmount != null);
		...
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'AssessmentReportIssueInDispute' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathAssessmentReportIssuesInDispute
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AssessmentReportIssueInDisputeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AssessmentReportIssueInDisputeEntityFactory))), (IEntityRelation)GetRelationsForField("AssessmentReportIssuesInDispute")[0], (int)PsychologicalServices.Data.EntityType.IssueInDisputeEntity, (int)PsychologicalServices.Data.EntityType.AssessmentReportIssueInDisputeEntity, 0, null, null, null, null, "AssessmentReportIssuesInDispute", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<IssueInDisputeInvoiceAmountEntity>(EntityFactoryCache2.GetEntityFactory(typeof(IssueInDisputeInvoiceAmountEntityFactory))), (IEntityRelation)GetRelationsForField("ReportTypeInvoiceAmount")[0], (int)PsychologicalServices.Data.EntityType.IssueInDisputeEntity, (int)PsychologicalServices.Data.EntityType.IssueInDisputeInvoiceAmountEntity, 0, null, null, null, null, "ReportTypeInvoiceAmount", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}

		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'ReferralTypeIssueInDispute' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathReferralTypeIssuesInDispute
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ReferralTypeIssueInDisputeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ReferralTypeIssueInDisputeEntityFactory))), (IEntityRelation)GetRelationsForField("ReferralTypeIssuesInDispute")[0], (int)PsychologicalServices.Data.EntityType.IssueInDisputeEntity, (int)PsychologicalServices.Data.EntityType.ReferralTypeIssueInDisputeEntity, 0, null, null, null, null, "ReferralTypeIssuesInDispute", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCompanyCollectionViaReportTypeInvoiceAmount
		{
			get
			{
				IEntityRelation intermediateRelation = Relations.IssueInDisputeInvoiceAmountEntityUsingIssueInDisputeId;
		...
		/// <summary> The IssueInDisputeId property of the Entity IssueInDispute<br/><br/></summary>
		...
		/// <summary> The Name property of the Entity IssueInDispute<br/><br/></summary>
		...
		/// <summary> The IsActive property of the Entity IssueInDispute<br/><br/></summary>
		...
		/// <summary> Gets the EntityCollection with the related entities of type 'AssessmentReportIssueInDisputeEntity' which are related to this entity via a relation of type '1:n'. If the EntityCollection hasn't been fetched yet, the collection returned will be empty.<br/><br/></summary>
		...
		{
			get { return GetOrCreateEntityCollection<AssessmentReportIssueInDisputeEntity, AssessmentReportIssueInDisputeEntityFactory>("IssueInDispute", true, false, ref _assessmentReportIssuesInDispute);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<IssueInDisputeInvoiceAmountEntity, IssueInDisputeInvoiceAmountEntityFactory>("IssueInDispute", true, false, ref _reportTypeInvoiceAmount);	}
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'ReferralTypeIssueInDisputeEntity' which are related to this entity via a relation of type '1:n'. If the EntityCollection hasn't been fetched yet, the collection returned will be empty.<br/><br/></summary>
		...
		{
			get { return GetOrCreateEntityCollection<ReferralTypeIssueInDisputeEntity, ReferralTypeIssueInDisputeEntityFactory>("IssueInDispute", true, false, ref _referralTypeIssuesInDispute);	}
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'CompanyEntity' which are related to this entity via a relation of type 'm:n'. If the EntityCollection hasn't been fetched yet, the collection returned will be empty.<br/><br/></summary>
		...
		{
			get { return GetOrCreateEntityCollection<CompanyEntity, CompanyEntityFactory>("", false, true, ref _companyCollectionViaReportTypeInvoiceAmount);	}
		}
