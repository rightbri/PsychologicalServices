...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'ReportType'.<br/><br/></summary>
	[Serializable]
	public partial class ReportTypeEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "AssessmentReports":
					toReturn.Add(Relations.AssessmentReportEntityUsingReportTypeId);
					break;
				case "AssessmentTypeReportTypes":
					toReturn.Add(Relations.AssessmentTypeReportTypeEntityUsingReportTypeId);
					break;
				default:
					break;				
			}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AssessmentReportEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AssessmentReportEntityFactory))), (IEntityRelation)GetRelationsForField("AssessmentReports")[0], (int)PsychologicalServices.Data.EntityType.ReportTypeEntity, (int)PsychologicalServices.Data.EntityType.AssessmentReportEntity, 0, null, null, null, null, "AssessmentReports", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AssessmentTypeReportTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AssessmentTypeReportTypeEntityFactory))), (IEntityRelation)GetRelationsForField("AssessmentTypeReportTypes")[0], (int)PsychologicalServices.Data.EntityType.ReportTypeEntity, (int)PsychologicalServices.Data.EntityType.AssessmentTypeReportTypeEntity, 0, null, null, null, null, "AssessmentTypeReportTypes", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <summary> The ReportTypeId property of the Entity ReportType<br/><br/></summary>
		...
		/// <summary> The Name property of the Entity ReportType<br/><br/></summary>
		...
		/// <summary> The IsActive property of the Entity ReportType<br/><br/></summary>
		...
		{
			get { return GetOrCreateEntityCollection<AssessmentReportEntity, AssessmentReportEntityFactory>("ReportType", true, false, ref _assessmentReports);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<AssessmentTypeReportTypeEntity, AssessmentTypeReportTypeEntityFactory>("ReportType", true, false, ref _assessmentTypeReportTypes);	}
		}
