...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'AppointmentStatus'.<br/><br/></summary>
	[Serializable]
	public partial class AppointmentStatusEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Appointments":
					toReturn.Add(Relations.AppointmentEntityUsingAppointmentStatusId);
					break;
				case "AppointmentStatusInvoiceRates":
					toReturn.Add(Relations.AppointmentStatusInvoiceRateEntityUsingAppointmentStatusId);
					break;
				case "PsychometristInvoiceAmounts":
					toReturn.Add(Relations.PsychometristInvoiceAmountEntityUsingAppointmentStatusId);
					break;
				default:
					break;				
			}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AppointmentEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AppointmentEntityFactory))), (IEntityRelation)GetRelationsForField("Appointments")[0], (int)PsychologicalServices.Data.EntityType.AppointmentStatusEntity, (int)PsychologicalServices.Data.EntityType.AppointmentEntity, 0, null, null, null, null, "Appointments", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AppointmentStatusInvoiceRateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AppointmentStatusInvoiceRateEntityFactory))), (IEntityRelation)GetRelationsForField("AppointmentStatusInvoiceRates")[0], (int)PsychologicalServices.Data.EntityType.AppointmentStatusEntity, (int)PsychologicalServices.Data.EntityType.AppointmentStatusInvoiceRateEntity, 0, null, null, null, null, "AppointmentStatusInvoiceRates", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <summary> The AppointmentStatusId property of the Entity AppointmentStatus<br/><br/></summary>
		...
		/// <summary> The Name property of the Entity AppointmentStatus<br/><br/></summary>
		...
		/// <summary> The Description property of the Entity AppointmentStatus<br/><br/></summary>
		...
		/// <summary> The IsActive property of the Entity AppointmentStatus<br/><br/></summary>
		...
		/// <summary> The NotifyReferralSource property of the Entity AppointmentStatus<br/><br/></summary>
		...
		/// <summary> The CanInvoice property of the Entity AppointmentStatus<br/><br/></summary>
		...
		/// <summary> The Sort property of the Entity AppointmentStatus<br/><br/></summary>
		...
		/// <summary> The ShowOnSchedule property of the Entity AppointmentStatus<br/><br/></summary>
		...
		/// <summary> The ClaimantSeen property of the Entity AppointmentStatus<br/><br/></summary>
		...
		/// <summary> The IsFinalStatus property of the Entity AppointmentStatus<br/><br/></summary>
		...
		{
			get { return GetOrCreateEntityCollection<AppointmentEntity, AppointmentEntityFactory>("AppointmentStatus", true, false, ref _appointments);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<AppointmentStatusInvoiceRateEntity, AppointmentStatusInvoiceRateEntityFactory>("AppointmentStatus", true, false, ref _appointmentStatusInvoiceRates);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<PsychometristInvoiceAmountEntity, PsychometristInvoiceAmountEntityFactory>("AppointmentStatus", true, false, ref _psychometristInvoiceAmounts);	}
		}
