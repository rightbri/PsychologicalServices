...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'Credibility'.<br/><br/></summary>
	[Serializable]
	public partial class CredibilityEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <summary> The CredibilityId property of the Entity Credibility<br/><br/></summary>
		...
		/// <summary> The Name property of the Entity Credibility<br/><br/></summary>
		...
		/// <summary> The IsActive property of the Entity Credibility<br/><br/></summary>
