...
namespace PsychologicalServices.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Addresses":
					toReturn.Add(Relations.AddressEntityUsingCityId);
					break;
				case "UserTravelFees":
					toReturn.Add(Relations.UserTravelFeeEntityUsingCityId);
					break;
				default:
					break;				
			}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AddressEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AddressEntityFactory))), (IEntityRelation)GetRelationsForField("Addresses")[0], (int)PsychologicalServices.Data.EntityType.CityEntity, (int)PsychologicalServices.Data.EntityType.AddressEntity, 0, null, null, null, null, "Addresses", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<UserTravelFeeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UserTravelFeeEntityFactory))), (IEntityRelation)GetRelationsForField("UserTravelFees")[0], (int)PsychologicalServices.Data.EntityType.CityEntity, (int)PsychologicalServices.Data.EntityType.UserTravelFeeEntity, 0, null, null, null, null, "UserTravelFees", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <summary> The CityId property of the Entity City<br/><br/></summary>
		...
		/// <summary> The Province property of the Entity City<br/><br/></summary>
		...
		/// <summary> The Country property of the Entity City<br/><br/></summary>
		...
		/// <summary> The IsActive property of the Entity City<br/><br/></summary>
		...
		{
			get { return GetOrCreateEntityCollection<AddressEntity, AddressEntityFactory>("City", true, false, ref _addresses);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<UserTravelFeeEntity, UserTravelFeeEntityFactory>("City", true, false, ref _userTravelFees);	}
		}
