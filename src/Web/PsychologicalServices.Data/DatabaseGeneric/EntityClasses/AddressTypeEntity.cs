...
namespace PsychologicalServices.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "AddressAddressTypes":
					toReturn.Add(Relations.AddressAddressTypeEntityUsingAddressTypeId);
					break;
				default:
					break;				
			}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AddressAddressTypeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AddressAddressTypeEntityFactory))), (IEntityRelation)GetRelationsForField("AddressAddressTypes")[0], (int)PsychologicalServices.Data.EntityType.AddressTypeEntity, (int)PsychologicalServices.Data.EntityType.AddressAddressTypeEntity, 0, null, null, null, null, "AddressAddressTypes", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <summary> The IsActive property of the Entity AddressType<br/><br/></summary>
		...
		{
			get { return GetOrCreateEntityCollection<AddressAddressTypeEntity, AddressAddressTypeEntityFactory>("AddressType", true, false, ref _addressAddressTypes);	}
		}
