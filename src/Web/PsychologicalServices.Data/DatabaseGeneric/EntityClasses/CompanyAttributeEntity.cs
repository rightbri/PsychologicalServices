...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'CompanyAttribute'.<br/><br/></summary>
	[Serializable]
	public partial class CompanyAttributeEntity : CommonEntityBase
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _attribute, new PropertyChangedEventHandler(OnAttributePropertyChanged), "Attribute", "CompanyAttributes", PsychologicalServices.Data.RelationClasses.StaticCompanyAttributeRelations.AttributeEntityUsingAttributeIdStatic, true, new int[] { (int)CompanyAttributeFieldIndex.AttributeId });
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _company, new PropertyChangedEventHandler(OnCompanyPropertyChanged), "Company", "CompanyAttributes", PsychologicalServices.Data.RelationClasses.StaticCompanyAttributeRelations.CompanyEntityUsingCompanyIdStatic, true, new int[] { (int)CompanyAttributeFieldIndex.CompanyId });
		}
		...
		{
			SetupSync(relatedEntity, ref _company, new PropertyChangedEventHandler( OnCompanyPropertyChanged ), "Company", "CompanyAttributes", PsychologicalServices.Data.RelationClasses.StaticCompanyAttributeRelations.CompanyEntityUsingCompanyIdStatic, true, new string[] {  }, new int[] { (int)CompanyAttributeFieldIndex.CompanyId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AttributeEntityFactory))),	(IEntityRelation)GetRelationsForField("Attribute")[0], (int)PsychologicalServices.Data.EntityType.CompanyAttributeEntity, (int)PsychologicalServices.Data.EntityType.AttributeEntity, 0, null, null, null, null, "Attribute", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The CompanyId property of the Entity CompanyAttribute<br/><br/></summary>
		...
		/// <summary> The AttributeId property of the Entity CompanyAttribute<br/><br/></summary>
		...
		public virtual AttributeEntity Attribute
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "CompanyAttributes", "Attribute", _attribute, true); 
				}
			}
		}
		...
		public virtual CompanyEntity Company
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "CompanyAttributes", "Company", _company, true); 
				}
			}
		}
