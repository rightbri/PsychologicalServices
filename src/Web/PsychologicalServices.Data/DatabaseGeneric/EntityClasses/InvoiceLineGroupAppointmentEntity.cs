...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'InvoiceLineGroupAppointment'.<br/><br/></summary>
	[Serializable]
	public partial class InvoiceLineGroupAppointmentEntity : CommonEntityBase
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _appointment, new PropertyChangedEventHandler(OnAppointmentPropertyChanged), "Appointment", "InvoiceLineGroupAppointments", PsychologicalServices.Data.RelationClasses.StaticInvoiceLineGroupAppointmentRelations.AppointmentEntityUsingAppointmentIdStatic, true, new int[] { (int)InvoiceLineGroupAppointmentFieldIndex.AppointmentId });
		}
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _invoiceLineGroup, new PropertyChangedEventHandler(OnInvoiceLineGroupPropertyChanged), "InvoiceLineGroup", "InvoiceLineGroupAppointment", PsychologicalServices.Data.RelationClasses.StaticInvoiceLineGroupAppointmentRelations.InvoiceLineGroupEntityUsingInvoiceLineGroupIdStatic, true, new int[] { (int)InvoiceLineGroupAppointmentFieldIndex.InvoiceLineGroupId });
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AppointmentEntityFactory))),	(IEntityRelation)GetRelationsForField("Appointment")[0], (int)PsychologicalServices.Data.EntityType.InvoiceLineGroupAppointmentEntity, (int)PsychologicalServices.Data.EntityType.AppointmentEntity, 0, null, null, null, null, "Appointment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(InvoiceLineGroupEntityFactory))), (IEntityRelation)GetRelationsForField("InvoiceLineGroup")[0], (int)PsychologicalServices.Data.EntityType.InvoiceLineGroupAppointmentEntity, (int)PsychologicalServices.Data.EntityType.InvoiceLineGroupEntity, 0, null, null, null, null, "InvoiceLineGroup", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		/// <summary> The InvoiceLineGroupId property of the Entity InvoiceLineGroupAppointment<br/><br/></summary>
		...
		/// <summary> The AppointmentId property of the Entity InvoiceLineGroupAppointment<br/><br/></summary>
		...
		public virtual AppointmentEntity Appointment
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "InvoiceLineGroupAppointments", "Appointment", _appointment, true); 
				}
			}
		}
		...
		public virtual InvoiceLineGroupEntity InvoiceLineGroup
		{
			...
			set
			{
				if(this.IsDeserializing)
				{
					...
					CallSetRelatedEntityDuringDeserialization(value, "InvoiceLineGroupAppointment");
				}
				else
				{
					if(value==null)
					...
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "InvoiceLineGroupAppointment");
							SetupSyncInvoiceLineGroup(value);
						}
					}
				}
