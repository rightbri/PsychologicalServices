...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'AppointmentAttribute'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class AppointmentAttributeEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return AppointmentAttributeEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Appointment":
					toReturn.Add(AppointmentAttributeEntity.Relations.AppointmentEntityUsingAppointmentId);
					break;
				case "Attribute":
					toReturn.Add(AppointmentAttributeEntity.Relations.AttributeEntityUsingAttributeId);
					break;
		...
		public bool TestOriginalFieldValueForNull(AppointmentAttributeFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(AppointmentAttributeFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(PsychologicalServices.Data.EntityType.AppointmentAttributeEntity);
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _appointment, new PropertyChangedEventHandler( OnAppointmentPropertyChanged ), "Appointment", AppointmentAttributeEntity.Relations.AppointmentEntityUsingAppointmentId, true, signalRelatedEntity, "AppointmentAttributes", resetFKFields, new int[] { (int)AppointmentAttributeFieldIndex.AppointmentId } );		
			_appointment = null;
		}
		...
		private void SetupSyncAppointment(IEntity2 relatedEntity)
		{
			if(_appointment!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _appointment, new PropertyChangedEventHandler( OnAppointmentPropertyChanged ), "Appointment", AppointmentAttributeEntity.Relations.AppointmentEntityUsingAppointmentId, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _attribute, new PropertyChangedEventHandler( OnAttributePropertyChanged ), "Attribute", AppointmentAttributeEntity.Relations.AttributeEntityUsingAttributeId, true, signalRelatedEntity, "AppointmentAttributes", resetFKFields, new int[] { (int)AppointmentAttributeFieldIndex.AttributeId } );		
			_attribute = null;
		}
		...
		private void SetupSyncAttribute(IEntity2 relatedEntity)
		{
			if(_attribute!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _attribute, new PropertyChangedEventHandler( OnAttributePropertyChanged ), "Attribute", AppointmentAttributeEntity.Relations.AttributeEntityUsingAttributeId, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathAppointment
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AppointmentEntityFactory))),
					(IEntityRelation)GetRelationsForField("Appointment")[0], (int)PsychologicalServices.Data.EntityType.AppointmentAttributeEntity, (int)PsychologicalServices.Data.EntityType.AppointmentEntity, 0, null, null, null, null, "Appointment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathAttribute
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AttributeEntityFactory))),
					(IEntityRelation)GetRelationsForField("Attribute")[0], (int)PsychologicalServices.Data.EntityType.AppointmentAttributeEntity, (int)PsychologicalServices.Data.EntityType.AttributeEntity, 0, null, null, null, null, "Attribute", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return AppointmentAttributeEntity.CustomProperties;}
		}
		...
		{
			get { return AppointmentAttributeEntity.FieldsCustomProperties;}
		}

		/// <summary> The AppointmentId property of the Entity AppointmentAttribute<br/><br/>
		/// </summary>
		...
		/// <summary> The AttributeId property of the Entity AppointmentAttribute<br/><br/>
		/// </summary>
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_appointment != null)
						{
							_appointment.UnsetRelatedEntity(this, "AppointmentAttributes");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "AppointmentAttributes");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_attribute != null)
						{
							_attribute.UnsetRelatedEntity(this, "AppointmentAttributes");
						}
					}
					else
					{
