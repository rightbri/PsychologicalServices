...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'ReportStatus'.<br/><br/></summary>
	[Serializable]
	public partial class ReportStatusEntity : CommonEntityBase
			...
			
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Assessments":
					toReturn.Add(Relations.AssessmentEntityUsingReportStatusId);
					break;
				default:
					break;				
			}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AssessmentEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AssessmentEntityFactory))), (IEntityRelation)GetRelationsForField("Assessments")[0], (int)PsychologicalServices.Data.EntityType.ReportStatusEntity, (int)PsychologicalServices.Data.EntityType.AssessmentEntity, 0, null, null, null, null, "Assessments", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <summary> The ReportStatusId property of the Entity ReportStatus<br/><br/></summary>
		...
		/// <summary> The Name property of the Entity ReportStatus<br/><br/></summary>
		...
		/// <summary> The IsActive property of the Entity ReportStatus<br/><br/></summary>
		...
		{
			get { return GetOrCreateEntityCollection<AssessmentEntity, AssessmentEntityFactory>("ReportStatus", true, false, ref _assessments);	}
		}
