...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'InvoiceStatusChange'.<br/><br/></summary>
	[Serializable]
	public partial class InvoiceStatusChangeEntity : CommonEntityBase
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _invoice, new PropertyChangedEventHandler(OnInvoicePropertyChanged), "Invoice", "InvoiceStatusChanges", PsychologicalServices.Data.RelationClasses.StaticInvoiceStatusChangeRelations.InvoiceEntityUsingInvoiceIdStatic, true, new int[] { (int)InvoiceStatusChangeFieldIndex.InvoiceId });
		}
		...
		{
			SetupSync(relatedEntity, ref _invoice, new PropertyChangedEventHandler( OnInvoicePropertyChanged ), "Invoice", "InvoiceStatusChanges", PsychologicalServices.Data.RelationClasses.StaticInvoiceStatusChangeRelations.InvoiceEntityUsingInvoiceIdStatic, true, new string[] {  }, new int[] { (int)InvoiceStatusChangeFieldIndex.InvoiceId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _invoiceStatus, new PropertyChangedEventHandler(OnInvoiceStatusPropertyChanged), "InvoiceStatus", "InvoiceStatusChanges", PsychologicalServices.Data.RelationClasses.StaticInvoiceStatusChangeRelations.InvoiceStatusEntityUsingInvoiceStatusIdStatic, true, new int[] { (int)InvoiceStatusChangeFieldIndex.InvoiceStatusId });
		}
		...
		{
			SetupSync(relatedEntity, ref _invoiceStatus, new PropertyChangedEventHandler( OnInvoiceStatusPropertyChanged ), "InvoiceStatus", "InvoiceStatusChanges", PsychologicalServices.Data.RelationClasses.StaticInvoiceStatusChangeRelations.InvoiceStatusEntityUsingInvoiceStatusIdStatic, true, new string[] {  }, new int[] { (int)InvoiceStatusChangeFieldIndex.InvoiceStatusId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(InvoiceStatusEntityFactory))),	(IEntityRelation)GetRelationsForField("InvoiceStatus")[0], (int)PsychologicalServices.Data.EntityType.InvoiceStatusChangeEntity, (int)PsychologicalServices.Data.EntityType.InvoiceStatusEntity, 0, null, null, null, null, "InvoiceStatus", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The InvoiceStatusChangeId property of the Entity InvoiceStatusChange<br/><br/></summary>
		...
		/// <summary> The InvoiceId property of the Entity InvoiceStatusChange<br/><br/></summary>
		...
		/// <summary> The InvoiceStatusId property of the Entity InvoiceStatusChange<br/><br/></summary>
		...
		/// <summary> The UpdateDate property of the Entity InvoiceStatusChange<br/><br/></summary>
		...
		public virtual InvoiceEntity Invoice
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "InvoiceStatusChanges", "Invoice", _invoice, true); 
				}
			}
		}
		...
		public virtual InvoiceStatusEntity InvoiceStatus
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "InvoiceStatusChanges", "InvoiceStatus", _invoiceStatus, true); 
				}
			}
		}
