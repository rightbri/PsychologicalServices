...
namespace PsychologicalServices.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'IssueInDisputeInvoiceAmount'.<br/><br/></summary>
	[Serializable]
	public partial class IssueInDisputeInvoiceAmountEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _company, new PropertyChangedEventHandler(OnCompanyPropertyChanged), "Company", "IssueInDisputeInvoiceAmounts", PsychologicalServices.Data.RelationClasses.StaticIssueInDisputeInvoiceAmountRelations.CompanyEntityUsingCompanyIdStatic, true, new int[] { (int)IssueInDisputeInvoiceAmountFieldIndex.CompanyId });
		}
		...
		{
			SetupSync(relatedEntity, ref _company, new PropertyChangedEventHandler( OnCompanyPropertyChanged ), "Company", "IssueInDisputeInvoiceAmounts", PsychologicalServices.Data.RelationClasses.StaticIssueInDisputeInvoiceAmountRelations.CompanyEntityUsingCompanyIdStatic, true, new string[] {  }, new int[] { (int)IssueInDisputeInvoiceAmountFieldIndex.CompanyId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _issueInDispute, new PropertyChangedEventHandler(OnIssueInDisputePropertyChanged), "IssueInDispute", "ReportTypeInvoiceAmount", PsychologicalServices.Data.RelationClasses.StaticIssueInDisputeInvoiceAmountRelations.IssueInDisputeEntityUsingIssueInDisputeIdStatic, true, new int[] { (int)IssueInDisputeInvoiceAmountFieldIndex.IssueInDisputeId });
		}
		...
		{
			SetupSync(relatedEntity, ref _issueInDispute, new PropertyChangedEventHandler( OnIssueInDisputePropertyChanged ), "IssueInDispute", "ReportTypeInvoiceAmount", PsychologicalServices.Data.RelationClasses.StaticIssueInDisputeInvoiceAmountRelations.IssueInDisputeEntityUsingIssueInDisputeIdStatic, true, new string[] {  }, new int[] { (int)IssueInDisputeInvoiceAmountFieldIndex.IssueInDisputeId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(IssueInDisputeEntityFactory))),	(IEntityRelation)GetRelationsForField("IssueInDispute")[0], (int)PsychologicalServices.Data.EntityType.IssueInDisputeInvoiceAmountEntity, (int)PsychologicalServices.Data.EntityType.IssueInDisputeEntity, 0, null, null, null, null, "IssueInDispute", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The CompanyId property of the Entity IssueInDisputeInvoiceAmount<br/><br/></summary>
		...
		/// <summary> The IssueInDisputeId property of the Entity IssueInDisputeInvoiceAmount<br/><br/></summary>
		...
		/// <summary> The InvoiceAmount property of the Entity IssueInDisputeInvoiceAmount<br/><br/></summary>
		...
		public virtual CompanyEntity Company
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "IssueInDisputeInvoiceAmounts", "Company", _company, true); 
				}
			}
		}
		...
		public virtual IssueInDisputeEntity IssueInDispute
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "ReportTypeInvoiceAmount", "IssueInDispute", _issueInDispute, true); 
				}
			}
		}
