...
namespace PsychologicalServices.Data.DatabaseSpecific
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		{
			base.AddElementMapping( "AppointmentStatusEntity", "PsychologicalServices", @"dbo", "AppointmentStatuses", 10 );
			...
			base.AddElementFieldMapping( "AppointmentStatusEntity", "IsFinalStatus", "IsFinalStatus", false, (int)SqlDbType.Bit, 0, 0, 0, false, "", null, typeof(System.Boolean), 9 );
		}
		...
		{
			base.AddElementMapping( "ClaimEntity", "PsychologicalServices", @"dbo", "Claims", 6 );
			...
			base.AddElementFieldMapping( "ClaimEntity", "InsuranceCompany", "InsuranceCompany", true, (int)SqlDbType.NVarChar, 50, 0, 0, false, "", null, typeof(System.String), 5 );
		}
		...
		{
			base.AddElementMapping( "CredibilityEntity", "PsychologicalServices", @"dbo", "Credibilities", 3 );
		...
		{
			base.AddElementMapping( "InvoiceLineGroupAppointmentEntity", "PsychologicalServices", @"dbo", "InvoiceLineGroupAppointments", 2 );
			base.AddElementFieldMapping( "InvoiceLineGroupAppointmentEntity", "InvoiceLineGroupId", "InvoiceLineGroupId", false, (int)SqlDbType.Int, 0, 0, 10, false, "", null, typeof(System.Int32), 0 );
			base.AddElementFieldMapping( "InvoiceLineGroupAppointmentEntity", "AppointmentId", "AppointmentId", false, (int)SqlDbType.Int, 0, 0, 10, false, "", null, typeof(System.Int32), 1 );
		}
		...
		{
			base.AddElementMapping( "UserEntity", "PsychologicalServices", @"dbo", "Users", 8 );
			...
			base.AddElementFieldMapping( "UserEntity", "DateInactivated", "DateInactivated", true, (int)SqlDbType.DateTimeOffset, 0, 0, 0, false, "", null, typeof(System.DateTimeOffset), 7 );
		}
